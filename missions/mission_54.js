...
const MISSION_54 = {
  ...
  steps: [
    ...
    // Q1 — MC
    {
      ...
      hint: 'Leon precisa fabricar novas armas no arsenal — new() garante que T tem construtor para isso',
      opts: [
    ...
    // Q2 — MC
    {
      ...
      hint: 'O arsenal aceita apenas armas de classe (tipo referência) que implementam a interface IAtiravel — vírgula combina ambas',
      opts: [
    ...
    // Q3 — MC
    {
      ...
      hint: 'Leon é um Agente — onde se espera um Agente, Leon serve. IEnumerable<string> segue essa mesma lógica de covariância',
      opts: [
    ...
    // Q4 — MC
    {
      ...
      hint: 'As balas de Leon são valores, não objetos — struct é o tipo de valor que nunca é null',
      opts: [
    ...
    // Q5 — MC
    {
      ...
      hint: 'Leon passa dois inteiros e o compilador sabe que T é int — inferência de tipo sem precisar declarar',
      opts: [
    ...
    // Q6 — MC
    {
      ...
      hint: 'Ashley some (null) e as balas zeram (0) — default(T) depende se T é referência ou valor',
      opts: [
    ...
    // Q7 — Fill
    {
      ...
      hint: 'Para Leon saber qual arma tem mais dano, ela precisa ser comparável — essa interface garante o CompareTo',
      ans: 'IComparable',
    ...
    // Q8 — Fill
    {
      ...
      hint: 'O arsenal cria novas armas do zero — essa constraint autoriza o "new T()" dentro do método',
      ans: 'new',
    ...
    // Q9 — Fill
    {
      ...
      hint: 'O repositório de missões aceita apenas objetos (tipo referência) — essa constraint garante que T não é struct',
      ans: 'class',
    ...
    // Q10 — Fill
    {
      ...
      hint: 'O inventário de Leon está vazio — retorne o valor que representa ausência para qualquer tipo T',
      ans: 'default',
    ...
    // Q11 — Fill
    {
      ...
      hint: 'Dados brutos da transmissão da Ilha sem referências gerenciadas — essa constraint permite uso com Span e ponteiros',
      ans: 'unmanaged',
    ...
    // Q12 — Code
    {
      ...
      hint: 'Leon dispara 3 vezes — o método genérico repete o símbolo e string.Join os une com vírgula',
      opts: [
        { t: '💥💥💥', ok: false },
        { t: '💥,💥,💥', ok: true },
        { t: '3', ok: false },
    ...
    // Q13 — Code
    {
      ...
      q: 'O que será exibido?',
      hint: 'Entre 42 e 17, o maior é mais perigoso; entre "Zebra" e "Abelha", quem vem depois no alfabeto?',
      opts: [
    ...
    // Q14 — Code
    {
      ...
      q: 'O que será exibido?',
      hint: 'O pool está vazio, então cria uma nova List<int> via new() — GetType().Name revela o tipo criado',
      opts: [
        { t: 'Pool`1', ok: false },
        { t: 'List`1', ok: true },
        { t: 'T', ok: false },
    ...
    // Q15 — Code
    {
      ...
      hint: 'Nomes de agentes são strings, e strings são objects — IEnumerable covariante permite essa substituição',
      opts: [
    ...
    // Q16 — Code
    {
      ...
      q: 'O que será exibido?',
      hint: 'O HP padrão de int é zero, ativo padrão de bool é falso, e Ashley sem nome é null — default revela isso',
      opts: [
    ...
    // Q17 — Code
    {
      ...
      q: 'O que será exibido?',
      hint: 'Leon troca as posições de duas armas no inventário — ref permite modificar os valores originais',
      opts: [
        { t: '10 20', ok: false },
        { t: '20 10', ok: true },
        { t: '0 0', ok: false },
    ...
    // Q18 — Code (DESAFIO CHEFE)
    {
      ...
      q: 'O que será exibido?',
      hint: 'Ada tem apenas 3 letras — o filtro exige mais de 3, então Leon e Ashley passam mas Ada não',
      opts: [
