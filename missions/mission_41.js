const MISSION_41 = {
  ...
  steps: [
    ...
    // Q1 — MC
    {
      ...
      hint: 'Leon não fica parado esperando a porta abrir — continua explorando enquanto Ada age',
      opts: [
    ...
    // Q2 — MC
    {
      ...
      hint: 'A relíquia leva tempo para ser encontrada — Task embrulha o valor que virá depois',
      opts: [
        { t: 'int', ok: false },
    ...
    // Q3 — MC
    {
      ...
      hint: 'Leon pausa a busca pela relíquia sem parar de respirar — o await suspende o método, não o agente',
      opts: [
    ...
    // Q4 — MC
    {
      ...
      hint: 'Um Ganado parado é alvo fácil; Leon em movimento é difícil de atingir — um bloqueia, o outro não',
      opts: [
    ...
    // Q5 — Fill
    {
      ...
      hint: 'Uma missão acessível a todos os agentes — como um método que qualquer um pode chamar',
      ans: 'public',
    ...
    // Q6 — Fill
    {
      ...
      hint: 'Leon aguarda o sinal de Ada antes de avançar — essa palavra desempacota o resultado da Task',
      ans: 'await',
    ...
    // Q7 — Fill
    {
      ...
      hint: 'A relíquia já está na mão de Leon — um Task que nasce com resultado pronto',
      ans: 'FromResult',
    ...
    // Q8 — Fill
    {
      ...
      hint: 'Leon neutraliza todos os guardas simultaneamente — aguarda todos terminarem de uma vez',
      ans: 'WhenAll',
    ...
    // Q9 — Code
    {
      ...
      hint: 'Ada confirmou: 42 Ganados na área — await desempacota o número da Task',
      opts: [
        { t: 'Task<int>', ok: false },
    ...
    // Q10 — Code
    {
      ...
      hint: 'Leon usa colete à prova de balas — o catch protege do impacto mesmo dentro do async',
      opts: [
    ...
    // Q11 — Code
    {
      ...
      q: 'O que será exibido?',
      hint: 'Leon (10 XP) e Ada (20 XP) completam missões em paralelo — some os resultados',
      opts: [
        { t: '10', ok: false },
        { t: '20', ok: false },
        { t: '30', ok: true },
    ...
    // Q12 — Code
    {
      ...
      hint: 'Ada não precisa voltar à base após cada operação — ConfigureAwait(false) evita essa ida e volta desnecessária',
      opts: [
