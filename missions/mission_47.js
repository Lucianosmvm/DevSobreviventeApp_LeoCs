const MISSION_47 = {
  ...
  steps: [
    ...
    // Q1 — MC
    {
      ...
      hint: 'O relógio do castelo muda com o fuso horário da Europa — UTC é o único marcador que não muda em lugar nenhum',
      opts: [
    ...
    // Q2 — MC
    {
      ...
      hint: 'Leon calcula quanto tempo levou para atravessar o castelo — a diferença entre dois DateTime vira uma duração',
      opts: [
    ...
    // Q3 — MC
    {
      ...
      hint: 'O relógio do Castelo recebe um símbolo inválido — Parse com string errada explode como uma granada',
      opts: [
    ...
    // Q4 — MC
    {
      ...
      hint: 'O relógio do castelo marca no padrão internacional — ano-mês-dia é a forma ISO que Ada usa nas transmissões',
      opts: [
    ...
    // Q5 — Fill
    {
      ...
      hint: 'Leon chegou à Espanha em 2005 no jogo — mas aqui a missão começa em que ano?',
      ans: '2025',
    ...
    // Q6 — Fill
    {
      ...
      hint: 'Leon tem 7 dias para escapar da Ilha — o método que empurra a data para o futuro',
      ans: 'AddDays',
    ...
    // Q7 — Fill
    {
      ...
      hint: 'Quantos segundos Leon ficou no Castelo? — a propriedade que soma toda a duração em segundos',
      ans: 'TotalSeconds',
    ...
    // Q8 — Fill
    {
      ...
      hint: 'O prazo de resgate de Ashley já passou — use o operador que verifica se uma data é anterior à outra',
      ans: '<',
    ...
    // Q9 — Code
    {
      ...
      hint: 'Leon começou a missão às 8h e terminou às 10h30 — quanto tempo o castelo devorou?',
      opts: [
        { t: '2h 0m', ok: false },
        { t: '2h 30m', ok: true },
        { t: '10h 30m', ok: false },
    ...
    // Q10 — Code
    {
      ...
      q: 'O que será exibido?',
      hint: 'A missão de Leon foi em 15 de março às 22h45 — o relógio do castelo registra o dia da semana também',
      opts: [
    ...
    // Q11 — Code
    {
      ...
      q: 'O que será exibido?',
      hint: 'O prazo para resgatar Ashley expira em 10 + 7 dias — a entrega no dia 18 chegou no prazo?',
      opts: [
        { t: 'No prazo', ok: false },
        { t: 'Atrasado', ok: true },
        { t: 'Erro', ok: false },
    ...
    // Q12 — Code
    {
      ...
      q: 'O que será exibido?',
      hint: 'Duas sessões de 90 minutos de treinamento com intervalo de 15 — quantas horas no total?',
      opts: [
        { t: '3.0h', ok: false },
        { t: '3.3h', ok: true },
        { t: '3.5h', ok: false },
