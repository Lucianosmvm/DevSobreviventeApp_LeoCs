...
const MISSION_69 = {
  ...
  steps: [
    ...
    // Q1 — MC
    {
      ...
      hint: 'O princípio final do SOLID — Leon depende de interfaces como IArma, nunca da Pistola concreta',
      opts: [
    ...
    // Q2 — MC
    {
      ...
      hint: 'Uma nova missão para cada operação de Leon — o ciclo de vida que cria uma instância por escopo ou request',
      opts: [
    ...
    // Q3 — MC
    {
      ...
      hint: 'Ashley escapa mas o rádio de Leon ainda transmite sinal para ela — subscriber descartado sem -=',
      opts: [
    ...
    // Q4 — MC
    {
      ...
      hint: 'Mesmo que um Ganado interrompa Leon no bunker, o using garante que a porta é sempre fechada ao sair',
      opts: [
    ...
    // Q5 — MC
    {
      ...
      hint: 'Leon espera Krauser liberar a passagem e Krauser espera Leon — espera circular sem saída',
      opts: [
    ...
    // Q6 — MC
    {
      ...
      hint: 'Leon troca de Shotgun para Rifle em plena missão sem parar — Strategy permite trocar o algoritmo em runtime',
      opts: [
    ...
    // Q7 — Fill
    {
      ...
      hint: 'O agente aceita qualquer arma que implemente o contrato — não a Pistola concreta',
      ans: 'IArma',
    ...
    // Q8 — Fill
    {
      ...
      hint: 'Leon só chama o rádio se alguém estiver ouvindo — o operador que verifica null antes de invocar',
      ans: '?',
    ...
    // Q9 — Fill
    {
      ...
      hint: 'Leon não elimina um Ganado já no chão — a flag evita executar Dispose duas vezes',
      ans: '_disposed',
    ...
    // Q10 — Fill
    {
      ...
      hint: 'Leon acumula XP sem lock — o método Interlocked que soma atomicamente',
      ans: 'Add',
    ...
    // Q11 — Fill
    {
      ...
      hint: 'Salazar organiza os inimigos por tipo antes do relatório final — o método LINQ que agrupa por chave',
      ans: 'GroupBy',
    ...
    // Q12 — Code
    {
      ...
      hint: 'O servico dobra o valor e depois Leon adiciona 10 XP de bônus — calcule passo a passo',
      opts: [
        { t: '25', ok: false },
        { t: '40', ok: true },
        { t: '30', ok: false },
    ...
    // Q13 — Code
    {
      ...
      q: 'O que será exibido?',
      hint: 'Três disparos do evento — some os valores de cada Fire() que o handler acumula',
      opts: [
        { t: '30', ok: false },
        { t: '60', ok: true },
        { t: '20', ok: false },
    ...
    // Q14 — Code
    {
      ...
      q: 'O que será exibido?',
      hint: 'Leon usa o recurso dentro do bunker e ao sair fecha a porta — acompanhe a ordem das letras impressas',
      opts: [
        { t: 'UDTrue', ok: false },
        { t: 'UDFalse', ok: true },
        { t: 'UD', ok: false },
    ...
    // Q15 — Code
    {
      ...
      q: 'O que será exibido?',
      hint: 'Dois agentes eliminam 1000 Ganados cada — o lock garante que nenhuma eliminação é perdida',
      opts: [
    ...
    // Q16 — Code
    {
      ...
      q: 'O que será exibido?',
      hint: 'O armeiro cria a calculadora correta para a operação — Factory retorna Mult para o operador de multiplicação',
      opts: [
        { t: '13', ok: false },
        { t: '42', ok: true },
        { t: '6', ok: false },
    ...
    // Q17 — Code
    {
      ...
      q: 'O que será exibido?',
      hint: 'Dois agentes do HQ somam seu XP e o agente de Field soma o dele — some separadamente por departamento',
      opts: [
    ...
    // Q18 — Code
    {
      ...
      q: 'O que será exibido?',
      hint: 'O Builder de Leon filtra apenas os Ganados com nível acima do mínimo — conte os que passam no predicado',
      opts: [
        { t: '2', ok: false },
        { t: '3', ok: true },
        { t: '5', ok: false },
    ...
    // Q19 — Code
    {
      ...
      q: 'O que será exibido?',
      hint: 'O helicóptero só comporta 2 agentes ao mesmo tempo — SemaphoreSlim limita a concorrência',
      opts: [
        { t: 'False', ok: false },
        { t: 'True', ok: true },
        { t: '2', ok: false },
    ...
    // Q20 — Code (DESAFIO FINAL)
    {
      ...
      q: 'O que será exibido?',
      hint: 'DoubleProc dobra cada valor e o evento acumula atomicamente — some os resultados dobrados de 5, 10 e 15',
      opts: [
        { t: '30', ok: false },
        { t: '60', ok: true },
        { t: '15', ok: false },
