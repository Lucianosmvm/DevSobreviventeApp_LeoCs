// ══════════════════════════════════════════════════════
// ACT II — O CASTELO
// MISSÃO 43 — A PASSAGEM SECRETA
// Tema: Extension Methods — criar, usar, boas práticas
// Tipo: Normal (12 questões) | Progressão: 4 MC → 4 Fill → 4 Code
// ══════════════════════════════════════════════════════

const missao43 = {
  id: 43, act: 2,
  titulo: "MISSÃO 43 — A PASSAGEM SECRETA",
  subtitulo: "O Castelo",
  descricao: "Leon descobre uma passagem oculta — uma extensão do mapa que ninguém esperava. Extension Methods adicionam funcionalidades a tipos existentes sem modificar seu código-fonte.",
  xp: 210, boss: false,
  steps: [
