...
const MISSION_72 = {
  ...
  steps: [
    ...
    // Q1 — MC
    {
      ...
      hint: 'Leon leva nome e HP direto na identidade — os parâmetros ficam disponíveis em todo o corpo da classe',
      opts: [
    ...
    // Q2 — MC
    {
      ...
      hint: 'O codinome de Leon é obrigatório mas pode ser fornecido em qualquer ordem no inicializador — sem fixar a posição no construtor',
      opts: [
    ...
    // Q3 — MC
    {
      ...
      hint: 'O armeiro do bunker disponibiliza as armas para todos os agentes — um único arquivo centraliza os usings globais',
      opts: [
    ...
    // Q4 — MC
    {
      ...
      hint: 'Leon age diretamente sem protocolo — top-level statements eliminam a cerimônia de class e Main',
      opts: [
    ...
    // Q5 — MC
    {
      ...
      hint: 'O recurso secreto de Leon visível apenas dentro do arquivo atual — mais restrito que internal',
      opts: [
    ...
    // Q6 — MC
    {
      ...
      hint: 'C# 12 usa colchetes para criar coleções como Leon usa o inventário — a nova sintaxe unificada',
      opts: [
    ...
    // Q7 — Fill
    {
      ...
      hint: 'O parâmetro do primary constructor tem o mesmo nome que aparece na assinatura da classe',
      ans: 'nome',
    ...
    // Q8 — Fill
    {
      ...
      hint: 'O código da missão é obrigatório — sem ele, Leon não pode operar; a palavra-chave em inglês para obrigatório',
      ans: 'required',
    ...
    // Q9 — Fill
    {
      ...
      hint: 'O namespace de Leon termina com o mesmo símbolo que encerra toda instrução em C#',
      ans: ';',
    ...
    // Q10 — Fill
    {
      ...
      hint: 'Leon expande o inventário de inimigos e chefes em um único array — o operador de dois pontos dentro de colchetes',
      ans: '..',
    ...
    // Q11 — Fill
    {
      ...
      hint: 'O sinal de rádio de Leon alcança toda a base — a palavra que torna o using disponível em todos os arquivos',
      ans: 'global',
    ...
    // Q12 — Code
    {
      ...
      hint: 'A Pistola de Leon carrega nome e dano definidos no primary constructor — Info() os formata juntos',
      opts: [
    ...
    // Q13 — Code
    {
      ...
      q: 'O que será exibido?',
      hint: 'O destino é obrigatório e a distância é configurada — ambos inicializados no object initializer',
      opts: [
    ...
    // Q14 — Code
    {
      ...
      q: 'O que será exibido?',
      hint: 'Leon combina o grupo de Ganados com o de chefes — o spread expande ambos os arrays antes de somar',
      opts: [
        { t: '30', ok: false },
        { t: '300', ok: false },
        { t: '330', ok: true },
    ...
    // Q15 — Code
    {
      ...
      q: 'O que será exibido?',
      hint: 'A Pistola de Leon está no namespace Jogo.Armas — o file-scoped namespace é válido e o Dano retorna 25',
      opts: [
    ...
    // Q16 — Code
    {
      ...
      q: 'O que será exibido?',
      hint: 'O rádio de Leon é injetado direto na identidade do serviço — primary constructor com DI, o log formata com ">"',
      opts: [
    ...
    // Q17 — Code
    {
      ...
      q: 'O que será exibido?',
      hint: 'Leon fornece a ApiKey obrigatória, mas a Url já tem um destino padrão do bunker',
      opts: [
        { t: 'null', ok: false },
    ...
    // Q18 — Code (DESAFIO CHEFE)
    {
      ...
      q: 'O que será exibido?',
      hint: 'O inventário de Leon não muda ao adicionar a Pistola — Adicionar cria um novo inventário com o item extra',
      opts: [
