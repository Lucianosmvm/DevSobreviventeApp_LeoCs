const MISSION_29 = {
  ...
  steps: [
    ...
    // Q1 — MC
    {
      ...
      hint: 'Ada passa ordens a Leon por mensageiro — delegate é o mensageiro que carrega uma função como dado',
      opts: [
    ...
    // Q2 — MC
    {
      ...
      hint: 'A lambda de Leon assume o tipo que o contexto exige — como ele troca de arma conforme a situação',
      opts: [
    ...
    // Q3 — MC
    {
      ...
      hint: 'No briefing de Ada: dois parâmetros de entrada, e o resultado final — o último tipo é o que ela entrega',
      opts: [
        { t: 'string', ok: false },
        { t: 'int', ok: false },
        { t: 'bool', ok: true },
    ...
    // Q4 — MC
    {
      ...
      hint: 'Hunnigan faz uma ação sem retornar nada; Ada sempre retorna algo — Action não devolve, Func devolve',
      opts: [
    ...
    // Q5 — MC
    {
      ...
      hint: 'Ada captura informações do ambiente ao seu redor mesmo quando não está presente — como uma closure memoriza o escopo',
      opts: [
    ...
    // Q6 — MC
    {
      ...
      hint: 'Quando Leon pressiona o rádio, todas as funções registradas respondem — multicast chama todas em sequência',
      opts: [
    ...
    // Q7 — Fill
    {
      ...
      hint: 'Ada usa um delegate que recebe dados e retorna resultado — qual tipo genérico representa funções com retorno?',
      ans: 'Func',
    ...
    // Q8 — Fill
    {
      ...
      hint: 'Hunnigan executa uma ação sem retornar nada — qual delegate representa ações sem retorno?',
      ans: 'Action',
    ...
    // Q9 — Fill
    {
      ...
      hint: 'El Gigante com mais de 100 HP é considerado grande — qual o limiar para classificar como "grande"?',
      ans: '100',
    ...
    // Q10 — Fill
    {
      ...
      hint: 'Leon adiciona outro receptor ao rádio de Hunnigan — o operador que adiciona ao delegate',
      ans: '+=',
    ...
    // Q11 — Fill
    {
      ...
      hint: 'A seta aponta: parâmetros de entrada de um lado, resultado do outro — qual símbolo é esse?',
      ans: '=>',
    ...
    // Q12 — Code
    {
      ...
      hint: 'Um acerto crítico de Leon dobra o dano base — rastreie os dois cenários de dano',
      opts: [
        { t: '60 e 30', ok: true },
        { t: '30 e 30', ok: false },
        { t: '60 e 60', ok: false },
    ...
    // Q13 — Code
    {
      ...
      q: 'O que será exibido?',
      hint: 'Leon conclui a missão e depois avisa Hunnigan — a função executa primeiro, depois o callback',
      opts: [
    ...
    // Q14 — Code
    {
      ...
      q: 'O que será exibido?',
      hint: 'Ada captura a referência do multiplicador, não o valor no momento — quando ela age, o valor já mudou',
      opts: [
    ...
    // Q15 — Code
    {
      ...
      q: 'O que será exibido?',
      hint: 'Leon encontra o primeiro inimigo em estado crítico — Find percorre em ordem e para no primeiro',
      opts: [
        { t: '5', ok: false },
        { t: '15', ok: true },
        { t: '45', ok: false },
    ...
    // Q16 — Code
    {
      ...
      hint: 'O rádio de Leon tem dois receptores registrados — ambos ouvem a mensagem ao mesmo tempo',
      opts: [
    ...
    // Q17 — Code
    {
      ...
      q: 'O que será exibido?',
      hint: 'Leon escolhe a estratégia de força — qual lambda é selecionada quando usarForca é true?',
      opts: [
        { t: '35', ok: false },
        { t: '45', ok: true },
        { t: '10', ok: false },
    ...
    // Q18 — Code
    {
      ...
      hint: 'O pipeline de Leon: dobra o dano, soma bônus e verifica se é grande — rastreie o valor 20 por cada etapa',
      opts: [
