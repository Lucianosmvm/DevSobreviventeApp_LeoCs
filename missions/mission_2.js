...
const MISSION_02 = {
  ...
  steps: [
    ...
    // Q1 — MC
    {
      ...
      hint:'Leon ignora a cor do Ganado — o que importa é o dano por tiro e quantos tiros ele deu',
      opts:[
    ...
    // Q2 — MC
    {
      ...
      hint:'A Pistola, a Escopeta e o Rifle têm mecânicas diferentes, mas todos seguem o mesmo padrão: alvejar e atirar',
      opts:[
    ...
    // Q3 — MC
    {
      ...
      hint:'17 balas divididas em grupos de 5 — quantas sobram para Leon após distribuir?',
      opts:[
        {t:'3', ok:false},
        {t:'3.4', ok:false},
        {t:'0', ok:false},
    ...
    // Q4 — MC
    {
      ...
      hint:'Leon não começa já eliminando Saddler — primeiro reconhece a Vila, depois o Castelo, depois a Ilha',
      opts:[
    ...
    // Q5 — MC
    {
      ...
      hint:'Ada rastreia cada passo de Leon no mapa antes de agir — simule o algoritmo antes de executar',
      opts:[
    ...
    // Q6 — Fill
    {
      ...
      hint:'Leon precisa saber se pode dividir os Ganados em dois grupos iguais — sem sobrar nenhum',
      ans:'2',
    ...
    // Q7 — Fill
    {
      ...
      hint:'Ashley precisa sair do esconderijo para Leon entrar — a variável intermediária guarda um valor por um instante',
      ans:'temp',
    ...
    // Q8 — Fill
    {
      ...
      hint:'El Gigante não pode ser dividido ao meio — só inteiros cabem neste cálculo',
      ans:'3',
    ...
    // Q9 — Fill
    {
      ...
      hint:'Cada Ganado eliminado adiciona um ao contador de Leon — dois sinais idênticos',
      ans:'++',
    ...
    // Q10 — Code
    {
      ...
      hint:'Faça o teste de mesa como Leon rastreia cada rota de fuga: 2 → +3 → ×2 → -1',
      opts:[
        {t:'8', ok:false},
        {t:'10', ok:false},
        {t:'9', ok:true},
    ...
    // Q11 — Code
    {
      ...
      hint:'Leon tem 15 balas e cada um dos 4 Ganados precisa de 3 tiros — faça as contas antes de entrar',
      opts:[
        {t:'False', ok:false},
        {t:'True', ok:true},
        {t:'15', ok:false},
    ...
    // Q12 — Code
    {
      ...
      q:'O que será exibido?',
      hint:'A variável temp é o depósito temporário — como Leon guardar a arma antes de pegar outra',
      opts:[
