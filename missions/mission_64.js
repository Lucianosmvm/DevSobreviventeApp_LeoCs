...
const MISSION_64 = {
  ...
  steps: [
    ...
    // Q1 — MC
    {
      ...
      hint: 'Leon conta quantos Ganados, Plagas e El Gigantes há — agrupe por tipo e conte cada grupo',
      opts: [
    ...
    // Q2 — MC
    {
      ...
      hint: 'Ada e Leon se encontram apenas quando ambos chegam ao mesmo ponto — sem correspondência, sem par',
      opts: [
    ...
    // Q3 — MC
    {
      ...
      hint: 'Leon acumula XP a cada Ganado eliminado — o acumulador começa em 0 e vai crescendo',
      opts: [
    ...
    // Q4 — MC
    {
      ...
      hint: 'A pistola e a TMP atiram da mesma forma — a query syntax é só uma forma diferente de escrever a mesma coisa',
      opts: [
    ...
    // Q5 — Fill
    {
      ...
      hint: 'Salazar separa os inimigos por tipo antes de enviá-los — o método que agrupa por chave',
      ans: 'GroupBy',
    ...
    // Q6 — Fill
    {
      ...
      hint: 'Leon encontra Ada pelo ID da operação — o método que une duas sequências por chave correspondente',
      ans: 'Join',
    ...
    // Q7 — Fill
    {
      ...
      hint: 'Leon concatena os relatórios de todos os agentes em um único documento — o método que reduz a lista a um valor acumulado',
      ans: 'Aggregate',
    ...
    // Q8 — Code
    {
      ...
      hint: 'O tipo mais frequente no castelo de Salazar aparece primeiro — ordene do mais comum para o menos comum',
      opts: [
    ...
    // Q9 — Code
    {
      ...
      q: 'O que será exibido?',
      hint: 'El Gigante causa o maior dano — o Aggregate vai mantendo o maior valor visto até agora',
      opts: [
        { t: '42', ok: false },
        { t: '67', ok: true },
        { t: '15', ok: false },
    ...
    // Q10 — Code
    {
      ...
      q: 'O que será exibido?',
      hint: 'Filtre apenas as missões do agente Leon após o join — as missões dele vêm pelo ID correspondente',
      opts: [
        { t: 'M1,M2,M3', ok: false },
        { t: 'M1,M2', ok: true },
        { t: 'M3', ok: false },
