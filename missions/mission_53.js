...
const MISSION_53 = {
  ...
  steps: [
    ...
    // Q1 — MC
    {
      ...
      hint: 'Leon verifica o rádio regularmente para saber se deve abortar — o cancelamento cooperativo funciona assim',
      opts: [
    ...
    // Q2 — MC
    {
      ...
      hint: 'Ada controla o botão de abortar a missão — CancellationTokenSource é quem pode cancelar, não o token',
      opts: [
    ...
    // Q3 — MC
    {
      ...
      hint: 'Quando Leon recebe o sinal de abortar, a operação lança essa exceção — qual o tipo correto?',
      opts: [
    ...
    // Q4 — MC
    {
      ...
      hint: 'A rede da Ilha tem 5 segundos de tolerância antes de ser cortada — o source com timeout automático',
      opts: [
    ...
    // Q5 — Fill
    {
      ...
      hint: 'Leon distribui o passe de cancelamento às operações — obtido nessa propriedade do CancellationTokenSource',
      ans: 'Token',
    ...
    // Q6 — Fill
    {
      ...
      hint: 'Leon verifica o rádio a cada Ganado neutralizado — esse método lança a exceção se o cancelamento foi solicitado',
    ...
    // Q7 — Fill
    {
      ...
      hint: 'Leon passa o passe de cancelamento para o Task.Delay — assim a espera pode ser interrompida a qualquer momento',
      ans: 'token',
    ...
    // Q8 — Code
    {
      ...
      hint: 'Ada abortou a missão antes de Leon começar — o token já estava cancelado quando Task.Delay foi chamado',
      opts: [
    ...
    // Q9 — Code
    {
      ...
      q: 'O que será exibido?',
      hint: 'O timeout da rede é de 200ms mas a operação demora 1 segundo — quem vence essa corrida?',
      opts: [
        { t: 'OK', ok: false },
        { t: 'Timeout!', ok: true },
        { t: 'Nada', ok: false },
    ...
    // Q10 — Code
    {
      ...
      hint: 'Leon cancela na terceira ronda — o while checa o token antes do próximo ciclo, então quantas rodadas completou?',
      opts: [
        { t: '2', ok: false },
        { t: '3', ok: true },
        { t: '4', ok: false },
