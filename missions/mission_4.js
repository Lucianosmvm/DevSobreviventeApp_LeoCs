...
const MISSION_04 = {
  ...
  steps: [
    ...
    // Q1 — MC
    {
      ...
      hint:'O inventário de Leon tem caixas etiquetadas: "municao", "hp", "ervas" — cada uma guarda um valor',
      opts:[
    ...
    // Q2 — MC
    {
      ...
      hint:'A Shotgun de Leon usa munição diferente da Pistola — tipo errado = não funciona',
      opts:[
    ...
    // Q3 — MC
    {
      ...
      hint:'Não existe meia bala no inventário de Leon — balas são sempre contadas sem decimais',
      opts:[
        {t:'string', ok:false},
        {t:'bool', ok:false},
        {t:'int', ok:true},
    ...
    // Q4 — MC
    {
      ...
      hint:'O HP de Leon na barra de vida pode ser 73.5% — um inteiro não comporta esse valor',
      opts:[
        {t:'int', ok:false},
        {t:'double', ok:true},
        {t:'bool', ok:false},
    ...
    // Q5 — MC
    {
      ...
      hint:'Missão concluída ou não — Ashley está resgatada ou não: só existe verdadeiro ou falso',
      opts:[
    ...
    // Q6 — MC
    {
      ...
      hint:'O nome "Leon S. Kennedy" não é um número — é uma sequência de caracteres',
      opts:[
        {t:'char', ok:false},
        {t:'string', ok:true},
        {t:'int', ok:false},
    ...
    // Q7 — MC
    {
      ...
      hint:'O grau "A" de Leon é uma letra isolada — char usa aspas simples, não duplas como string',
      opts:[
    ...
    // Q8 — Fill
    {
      ...
      hint:'30 balas no carregador de Leon — sem casas decimais, sem texto',
      ans:'int',
    ...
    // Q9 — Fill
    {
      ...
      hint:'O compilador vê 100 e sabe que Leon não está guardando um decimal — que tipo é 100?',
      ans:'int',
    ...
    // Q10 — Fill
    {
      ...
      hint:'O HP de Leon começa sempre cheio — qual valor representa saúde máxima num jogo?',
      ans:'100',
    ...
    // Q11 — Fill
    {
      ...
      hint:'Quem é o agente que resgatou Ashley e confrontou Saddler?',
      ans:'Leon',
    ...
    // Q12 — Fill
    {
      ...
      hint:'O sufixo é a inicial do próprio tipo — como a inicial do nome de Leon no crachá',
      ans:'f',
    ...
    // Q13 — Code
    {
      ...
      hint:'Leon exibe o nome da arma, não as balas nem o HP — siga a variável passada ao WriteLine',
      opts:[
    ...
    // Q14 — Code
    {
      ...
      hint:'O inventário de balas de Leon não aceita a palavra "três" — ele precisa do número 3',
      opts:[
    ...
    // Q15 — Code
    {
      ...
      q:'O que será exibido?',
      hint:'7 Ganados divididos por 2 patrulhas — inteiro perde o resto, double preserva a fração',
      opts:[
        {t:'3 | 3', ok:false},
        {t:'3 | 3.5', ok:true},
        {t:'3.5 | 3.5', ok:false},
    ...
    // Q16 — Code
    {
      ...
      q:'O que será exibido?',
      hint:'O relatório de Leon combina texto com número — o C# converte automaticamente ao concatenar',
      opts:[
        {t:'Kills: 42', ok:true},
    ...
    // Q17 — Code
    {
      ...
      q:'O que será exibido?',
      hint:'Leon está vivo mas sem arma — ambas as condições precisam ser verdadeiras para lutar',
      opts:[
    ...
    // Q18 — Code
    {
      ...
      q:'O que será exibido?',
      hint:'A interpolação converte cada variável — lembre que bool vira "True" com maiúscula em C#',
      opts:[
