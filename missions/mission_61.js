...
const MISSION_61 = {
  ...
  steps: [
    ...
    // Q1 — MC
    {
      ...
      hint: 'Um único tiro de granada alerta todos os Ganados da Vila ao mesmo tempo',
      opts: [
    ...
    // Q2 — MC
    {
      ...
      hint: 'O rádio do Leon sempre identifica quem transmite e qual é a mensagem — é o protocolo padrão da operação',
      opts: [
    ...
    // Q3 — MC
    {
      ...
      hint: 'Se Ashley escapa antes de Leon, o rádio dela ainda transmite sinal mesmo ela já estando a salvo',
      opts: [
    ...
    // Q4 — MC
    {
      ...
      hint: 'Enquanto Leon verifica se o Regenerador ainda está vivo e decide atirar, o alvo pode ter sumido — checar e invocar juntos elimina essa janela',
      opts: [
    ...
    // Q5 — Fill
    {
      ...
      hint: 'O relatório de ameaça de Leon herda do formato padrão de inteligência da operação',
      ans: 'EventArgs',
    ...
    // Q6 — Fill
    {
      ...
      hint: 'O sistema de vigilância notifica o que já aconteceu — o evento é nomeado no passado como uma ocorrência confirmada',
      ans: 'AmeacaDetectada',
    ...
    // Q7 — Fill
    {
      ...
      hint: 'Leon adiciona um novo aliado à operação — o operador combina adição e atribuição ao mesmo tempo',
      ans: '+=',
    ...
    // Q8 — Code
    {
      ...
      hint: 'Leon aciona o alarme e dois subsistemas respondem — conte quantos handlers foram inscritos',
      opts: [
        { t: '1', ok: false },
        { t: '2', ok: true },
        { t: '0', ok: false },
    ...
    // Q9 — Code
    {
      ...
      hint: 'O sensor transmite os dados do evento para Ashley — o valor vem dentro do pacote de dados',
      opts: [
        { t: 'Sensor: 0', ok: false },
        { t: 'Sensor: 42', ok: true },
    ...
    // Q10 — Code
    {
      ...
      hint: 'Leon se retira da operação antes do segundo alarme — desinscrito antes do Acionar, ele não conta mais',
      opts: [
        { t: '0', ok: false },
        { t: '1', ok: true },
        { t: '2', ok: false },
