...
const MISSION_12 = {
  ...
  steps: [
    ...
    // Q1 — MC
    {
      ...
      hint:'O arsenal de Leon começa pelo primeiro slot — em programação, contamos a partir de qual número?',
      opts:[
    ...
    // Q2 — MC
    {
      ...
      hint:'O inventário de Leon tem 5 slots (0 a 4) — tentar acessar o slot 5 é como pegar algo que não existe',
      opts:[
    ...
    // Q3 — MC
    {
      ...
      hint:'O inventário de Leon tem slots fixos — não pode expandir no meio da missão como uma List',
      opts:[
    ...
    // Q4 — MC
    {
      ...
      hint:'Leon reorganiza as armas no próprio inventário sem criar um novo — é in-place mesmo',
      opts:[
    ...
    // Q5 — Fill
    {
      ...
      hint:'O arsenal tem 5 slots — o número entre colchetes define a capacidade do array',
      ans:'5',
    ...
    // Q6 — Fill
    {
      ...
      hint:'O inventário de Leon abre com uma chave — qual símbolo inicia o bloco de valores?',
      ans:'{',
    ...
    // Q7 — Fill
    {
      ...
      hint:'Leon pega a primeira arma do arsenal — os arrays começam no índice zero',
      ans:'0',
    ...
    // Q8 — Fill
    {
      ...
      hint:'Leon inverte a ordem dos inimigos na lista — qual método do Array faz isso?',
      ans:'Reverse',
    ...
    // Q9 — Code
    {
      ...
      hint:'O HP do segundo Ganado (índice 1) foi alterado para 50 — o primeiro e o terceiro não mudaram',
      opts:[
    ...
    // Q10 — Code
    {
      ...
      q:'O que será exibido?',
      hint:'Leon ordena as armas do menor ao maior dano — o Array.Sort faz isso em ordem crescente',
      opts:[
    ...
    // Q11 — Code
    {
      ...
      q:'O que será exibido?',
      hint:'Leon procura a Escopeta no arsenal — IndexOf retorna a posição onde ela está guardada',
      opts:[
    ...
    // Q12 — Code
    {
      ...
      hint:'Quantas missões Leon concluiu? Conte apenas os valores true no array de missões',
      opts:[
