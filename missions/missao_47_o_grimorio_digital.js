// ══════════════════════════════════════════════════════
// ACT II — O CASTELO
// MISSÃO 47 — O GRIMÓRIO DIGITAL
// Tema: JSON — System.Text.Json, Serialize, Deserialize, JsonOptions
// Tipo: Normal (12 questões) | Progressão: 4 MC → 4 Fill → 4 Code
// ══════════════════════════════════════════════════════

const missao47 = {
  id: 47, act: 2,
  titulo: "MISSÃO 47 — O GRIMÓRIO DIGITAL",
  subtitulo: "O Castelo",
  descricao: "O grimório foi digitalizado — dados transmitidos em JSON entre sistemas. System.Text.Json é a biblioteca nativa do .NET para serializar e desserializar dados JSON.",
  xp: 210, boss: false,
  steps: [
