// ══════════════════════════════════════════════════════
// ACT II — O CASTELO
// MISSÃO 42 — O RELICÁRIO
// Tema: async/await, Task, Task<T>, operações assíncronas
// Tipo: Normal (12 questões) | Progressão: 4 MC → 4 Fill → 4 Code
// ══════════════════════════════════════════════════════

const missao42 = {
  id: 42, act: 2,
  titulo: "MISSÃO 42 — O RELICÁRIO",
  subtitulo: "O Castelo",
  descricao: "As relíquias do castelo levam tempo para serem encontradas — enquanto espera, Leon não fica parado. async/await permite executar operações demoradas sem travar o programa.",
  xp: 220, boss: false,
  steps: [
