// ══════════════════════════════════════════════════════
// ACT II — O CASTELO
// MISSÃO 45 — O TRONO PROIBIDO ⚔️ MISSÃO CHEFE
// Tema: Revisão — Exceções, Strings, Tuplas, Enums, Structs,
//        Eventos, Async, Extension Methods, Pattern Matching
// Tipo: CHEFE (18 questões) | Progressão: 6 MC → 5 Fill → 7 Code
// ══════════════════════════════════════════════════════

const missao45 = {
  id: 45, act: 2,
  titulo: "MISSÃO 45 — O TRONO PROIBIDO",
  subtitulo: "O Castelo • Missão Chefe ⚔️",
  descricao: "O trono proibido só pode ser alcançado por quem domina todos os segredos do castelo. Uma revisão brutal dos temas 36 a 44 — exceções, eventos, async, extensions e patterns.",
  xp: 290, boss: true,
  steps: [
