// ══════════════════════════════════════════════════════
// ACT II — O CASTELO
// MISSÃO 26 — A BIBLIOTECA
// Tema: Encapsulamento, Properties (get/set), campos privados
// Tipo: Normal (12 questões) | Progressão: 4 MC → 4 Fill → 4 Code
// ══════════════════════════════════════════════════════

const missao26 = {
  id: 26, act: 2,
  titulo: "MISSÃO 26 — A BIBLIOTECA",
  subtitulo: "O Castelo",
  descricao: "A biblioteca do castelo guarda segredos que não podem ser acessados por qualquer um. Encapsulamento é a arte de proteger os dados internos de um objeto, expondo apenas o necessário.",
  xp: 180, boss: false,
  steps: [
