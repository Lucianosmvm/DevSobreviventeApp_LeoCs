...
const MISSION_09 = {
  ...
  steps: [
    ...
    // Q1 — MC
    {
      ...
      hint:'Leon patrulha enquanto há Ganados — a condição do while é o gatilho para continuar ou parar',
      opts:[
    ...
    // Q2 — MC
    {
      ...
      hint:'O Regenerador não morre sem a Rifle Thermal — sem atualizar a variável de controle, o loop nunca para',
      opts:[
    ...
    // Q3 — MC
    {
      ...
      hint:'Leon sempre verifica o mapa pelo menos uma vez antes de decidir continuar — o do-while garante isso',
      opts:[
    ...
    // Q4 — MC
    {
      ...
      hint:'break é Leon saindo da Vila inteira; continue é pular um Ganado e ir para o próximo',
      opts:[
    ...
    // Q5 — MC
    {
      ...
      hint:'Leon começa com munição (inicializa), verifica se tem bala (testa) e atira (atualiza) — são 3 fases',
      opts:[
    ...
    // Q6 — MC
    {
      ...
      hint:'Leon acumula o dano total em "soma" a cada Ganado eliminado — o acumulador cresce a cada iteração',
      opts:[
    ...
    // Q7 — Fill
    {
      ...
      hint:'Leon patrulha "enquanto" ainda tem vidas — a palavra em inglês inicia o loop',
      ans:'while',
    ...
    // Q8 — Fill
    {
      ...
      hint:'Leon usa essa palavra para sair imediatamente do combate — a saída de emergência do loop',
      ans:'break',
    ...
    // Q9 — Fill
    {
      ...
      hint:'Leon pula o Ganado nº 3 e vai direto para o próximo — sem encerrar o patrulhamento',
      ans:'continue',
    ...
    // Q10 — Fill
    {
      ...
      hint:'O do-while começa com a ação antes da condição — qual palavra vai antes das chaves?',
      ans:'do',
    ...
    // Q11 — Fill
    {
      ...
      hint:'Leon começa o inventário com zero munição antes de acumular — o neutro da soma',
      ans:'0',
    ...
    // Q12 — Code
    {
      ...
      hint:'Leon conta regressivamente os Ganados: começa em 5 e vai eliminando até n > 0 falhar',
      opts:[
    ...
    // Q13 — Code
    {
      ...
      hint:'O HP de Leon nunca diminui dentro do loop — é como o Regenerador que ninguém consegue matar',
      opts:[
    ...
    // Q14 — Code
    {
      ...
      hint:'Leon acumula os danos de cada Ganado — some o array inteiro para ver o total',
      opts:[
    ...
    // Q15 — Code
    {
      ...
      q:'O que será exibido?',
      hint:'Leon pula os Ganados de número par e só relata os ímpares — o continue os ignora',
      opts:[
    ...
    // Q16 — Code
    {
      ...
      hint:'O menu de combate de Leon aparece sempre uma vez — ele só sai quando o jogador escolher a opção 3',
      opts:[
    ...
    // Q17 — Code
    {
      ...
      hint:'Leon busca o primeiro inimigo fraco no array — qual índice tem HP abaixo de 20?',
      opts:[
    ...
    // Q18 — Code
    {
      ...
      hint:'Quantas formas Leon pode organizar 5 armas no inventário? 5 × 4 × 3 × 2 × 1',
      opts:[
