// ══════════════════════════════════════════════════════
// ACT II — O CASTELO
// MISSÃO 24 — CORREDOR DAS ARMADURAS
// Tema: Stack<T>, Queue<T> e HashSet<T>
// Tipo: Normal (11 questões) | Progressão: 4 MC → 3 Fill → 4 Code
// ══════════════════════════════════════════════════════

const missao24 = {
  id: 24, act: 2,
  titulo: "MISSÃO 24 — CORREDOR DAS ARMADURAS",
  subtitulo: "O Castelo",
  descricao: "As armaduras enfileiradas, as armas empilhadas, os itens únicos nos pedestais. Stack, Queue e HashSet — cada estrutura serve a um propósito específico.",
  xp: 170, boss: false,
  steps: [
