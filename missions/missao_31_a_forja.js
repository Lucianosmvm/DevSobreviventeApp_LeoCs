...
// ACT II — O CASTELO
// MISSÃO 31 — A FORJA
// Tema: Generics — classes, métodos e constraints
// Tipo: Normal (12 questões) | Progressão: 4 MC → 4 Fill → 4 Code
// ══════════════════════════════════════════════════════

const missao31 = {
  id: 31, act: 2,
  titulo: "MISSÃO 31 — A FORJA",
  subtitulo: "O Castelo",
  descricao: "Na forja do castelo, o ferreiro cria armaduras para qualquer tamanho de guerreiro usando o mesmo molde. Generics permitem escrever código que funciona com qualquer tipo — o molde universal.",
  xp: 200, boss: false,
  steps: [
