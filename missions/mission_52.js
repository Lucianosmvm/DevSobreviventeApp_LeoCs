...
const MISSION_52 = {
  ...
  steps: [
    ...
    // Q1 — MC
    {
      ...
      hint: 'Leon precisa saber se foi uma armadilha das Plagas ou um erro de equipamento — exceções customizadas comunicam o tipo exato',
      opts: [
    ...
    // Q2 — MC
    {
      ...
      hint: 'Leon verifica a ameaça antes de acionar a armadilha — when avalia sem capturar a exceção prematuramente',
      opts: [
    ...
    // Q3 — MC
    {
      ...
      hint: 'O rastro de Leon no laboratório mostra exatamente onde o erro começou — throw; preserva esse rastro original',
      opts: [
    ...
    // Q4 — MC
    {
      ...
      hint: 'Múltiplas armadilhas do laboratório explodiram ao mesmo tempo — AggregateException guarda todas numa coleção',
      opts: [
    ...
    // Q5 — Fill
    {
      ...
      hint: 'Todo erro do laboratório herda de um problema fundamental — exceções customizadas herdam desta classe raiz',
      ans: 'Exception',
    ...
    // Q6 — Fill
    {
      ...
      hint: 'Leon só aciona o protocolo crítico quando a mensagem contém essa palavra — o filtro do catch usa essa cláusula',
      ans: 'when',
    ...
    // Q7 — Fill
    {
      ...
      hint: 'Leon relança a exceção sem criar uma nova — throw sem nome preserva o rastro original do laboratório',
      ans: 'throw',
    ...
    // Q8 — Code
    {
      ...
      hint: 'Leon morreu! — a mensagem foi passada ao construtor base e aparece em ex.Message',
      opts: [
    ...
    // Q9 — Code
    {
      ...
      hint: 'O código 50 não é crítico (não é maior que 100) — qual catch captura esse caso?',
      opts: [
    ...
    // Q10 — Code
    {
      ...
      q: 'O que será exibido?',
      hint: 'MissaoFalhouException é mais específico que MissaoException — o catch mais preciso deve vir antes',
      opts: [
