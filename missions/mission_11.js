...
const MISSION_11 = {
  ...
  steps: [
    ...
    // Q1 — MC
    {
      ...
      hint:'Leon elimina cada Ganado da horda sem precisar contar o índice — o foreach faz isso automaticamente',
      opts:[
    ...
    // Q2 — MC
    {
      ...
      hint:'Ashley não pode ser substituída durante a missão — a variável do foreach também é somente leitura',
      opts:[
    ...
    // Q3 — MC
    {
      ...
      hint:'O arsenal de Leon inclui pistola, escopeta e rifle — o foreach percorre qualquer coleção que implemente IEnumerable',
      opts:[
    ...
    // Q4 — Fill
    {
      ...
      hint:'Para cada inimigo "dentro de" (___) a lista de inimigos — qual palavra conecta variável à coleção?',
      ans:'in',
    ...
    // Q5 — Fill
    {
      ...
      hint:'O compilador detecta o tipo do inventário automaticamente — como Leon identifica uma arma sem precisar da etiqueta',
      ans:'var',
    ...
    // Q6 — Fill
    {
      ...
      hint:'O arsenal de Leon tem armas e suas munições — para listar as armas, use a propriedade de chaves do Dictionary',
      ans:'Keys',
    ...
    // Q7 — Code
    {
      ...
      hint:'A horda tem Ganado, Cultista e Regenerador — um por linha, quantos inimigos no array?',
      opts:[
    ...
    // Q8 — Code
    {
      ...
      hint:'Leon soma o dano de cada Ganado eliminado — some todos os valores do array',
      opts:[
    ...
    // Q9 — Code
    {
      ...
      hint:'O for mostra a posição da arma no arsenal; o foreach mostra só o nome — qual exibe o índice?',
      opts:[
    ...
    // Q10 — Code
    {
      ...
      hint:'O arsenal de Leon no Dictionary tem arma (Key) e munição (Value) — o foreach itera os pares',
      opts:[
