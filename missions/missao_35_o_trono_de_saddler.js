// ══════════════════════════════════════════════════════
// ACT II — O CASTELO
// MISSÃO 35 — O TRONO DE SADDLER ⚔️ MISSÃO CHEFE
// Tema: Revisão Act II (21-34) — Coleções, OOP, LINQ, Lambda, Generics, Null, Recursão, Big O
// Tipo: CHEFE (18 questões) | Progressão: 5 MC → 4 Fill → 9 Code
// ══════════════════════════════════════════════════════

const missao35 = {
  id: 35, act: 2,
  titulo: "MISSÃO 35 — O TRONO DE SADDLER",
  subtitulo: "O Castelo • Missão Chefe ⚔️",
  descricao: "Saddler te aguarda no trono. Para chegar até ele, você precisa provar que domina tudo que o Castelo ensinou. Esta é a revisão completa — sem misericórdia.",
  xp: 350, boss: true,
  steps: [
