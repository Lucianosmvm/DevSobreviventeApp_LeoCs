const MISSION_28 = {
  ...
  steps: [
    ...
    // Q1 — MC
    {
      ...
      hint: 'Leon filtra apenas os inimigos com HP baixo da lista — elimina os que não atendem à condição',
      opts: [
    ...
    // Q2 — MC
    {
      ...
      hint: 'Ada prepara o plano mas só age quando Leon chama — LINQ é preguiçoso como uma espiã aguardando o momento certo',
      opts: [
    ...
    // Q3 — MC
    {
      ...
      hint: 'Hunnigan transforma cada nome dos agentes para maiúsculas no relatório — um por um',
      opts: [
    ...
    // Q4 — MC
    {
      ...
      hint: 'Ashley pode não estar na sala — FirstOrDefault evita a exceção quando a busca não encontra nada',
      opts: [
    ...
    // Q5 — Fill
    {
      ...
      hint: 'Leon seleciona apenas os inimigos com HP crítico — a palavra em inglês para "onde a condição é verdadeira"',
      ans: 'Where',
    ...
    // Q6 — Fill
    {
      ...
      hint: 'Hunnigan extrai apenas os nomes dos inimigos do relatório completo — projeta o que interessa',
      ans: 'Select',
    ...
    // Q7 — Fill
    {
      ...
      hint: 'Leon quer os inimigos mais perigosos primeiro — inverte a ordem crescente para decrescente',
      ans: 'Reverse',
    ...
    // Q8 — Fill
    {
      ...
      hint: 'Hunnigan materializa o relatório de inimigos em uma lista concreta para Leon usar em campo',
      ans: 'ToList',
    ...
    // Q9 — Code
    {
      ...
      hint: 'Leon filtra os inimigos com HP ≥ 40 e os enfrenta do mais fraco ao mais forte',
      opts: [
        { t: '80, 45, 60', ok: false },
        { t: '45, 60, 80', ok: true },
    ...
    // Q10 — Code
    {
      ...
      hint: 'Hunnigan converte cada tupla de inimigo num relatório de texto — quantos inimigos, quantas linhas?',
      opts: [
        { t: '1', ok: false },
        { t: '3', ok: true },
        { t: '6', ok: false },
    ...
    // Q11 — Code
    {
      ...
      hint: 'Hunnigan soma os HPs, conta os críticos e verifica se algum inimigo está morto — três perguntas, três respostas',
      opts: [
    ...
    // Q12 — Code
    {
      ...
      q: 'O que será exibido?',
      hint: 'O inimigo com maior HP é o chefe da sala — ordene do mais forte e pegue o primeiro',
      opts: [
        { t: 'Ganado', ok: false },
        { t: 'Cultista', ok: false },
        { t: 'Krauser', ok: true },
