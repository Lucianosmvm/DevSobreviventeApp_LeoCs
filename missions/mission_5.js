...
const MISSION_05 = {
  ...
  steps: [
    ...
    // Q1 — MC
    {
      ...
      hint:'O número de Plagas infectadas pela Illuminados é grande demais para um int suportar',
      opts:[
    ...
    // Q2 — MC
    {
      ...
      hint:'O Regenerador sempre renasce quando excede o limite — o int faz o mesmo ao ultrapassar MaxValue',
      opts:[
    ...
    // Q3 — MC
    {
      ...
      hint:'O comerciante de RE4 não aceita imprecisão nos preços — centavos exatos exigem o tipo certo',
      opts:[
        {t:'int', ok:false},
        {t:'double', ok:false},
        {t:'decimal', ok:true},
    ...
    // Q4 — MC
    {
      ...
      hint:'Converter o HP 73.9 para inteiro é como Leon perder 0.9 de vida — a parte decimal desaparece',
      opts:[
    ...
    // Q5 — Fill
    {
      ...
      hint:'O cast usa o tipo de destino entre parênteses — qual tipo Leon quer ao final?',
      ans:'int',
    ...
    // Q6 — Fill
    {
      ...
      hint:'Leon converte o número de kills para exibir no relatório — o método faz isso para qualquer tipo',
      ans:'ToString',
    ...
    // Q7 — Fill
    {
      ...
      hint:'Ashley some no Castelo — null é ausência de valor; o método checa isso antes de processar',
      ans:'IsNullOrEmpty',
    ...
    // Q8 — Fill
    {
      ...
      hint:'O comerciante trabalha com dinheiro preciso — o sufixo é a inicial de "money"',
      ans:'m',
    ...
    // Q9 — Code
    {
      ...
      hint:'O int de Leon tem limites — como a barra de HP tem um máximo e um mínimo',
      opts:[
    ...
    // Q10 — Code
    {
      ...
      q:'O que será exibido?',
      hint:'O rádio transmitiu texto de Ganado — tentar converter "abc" para número falha silenciosamente com TryParse',
      opts:[
    ...
    // Q11 — Code
    {
      ...
      hint:'A mira de Leon nunca é 100% precisa com float e double — ponto flutuante tem imprecisões binárias',
      opts:[
