...
// ACT II — O CASTELO
// MISSÃO 27 — A GALERIA
// Tema: Herança, override, virtual, base, polimorfismo
// Tipo: Normal (12 questões) | Progressão: 4 MC → 4 Fill → 4 Code
// ══════════════════════════════════════════════════════

const missao27 = {
  id: 27, act: 2,
  titulo: "MISSÃO 27 — A GALERIA",
  subtitulo: "O Castelo",
  descricao: "Na galeria de retratos, cada inimigo é uma variação do mesmo tema. Herança permite criar hierarquias de classes — o Regenerador é um Inimigo, mas com poderes extras.",
  xp: 190, boss: false,
  steps: [
