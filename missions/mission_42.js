const MISSION_42 = {
  ...
  steps: [
    ...
    // Q1 — MC
    {
      ...
      hint: 'A passagem secreta tem três travas: a sala é estática, a porta é estática, e o "this" aponta o que está sendo estendido',
      opts: [
    ...
    // Q2 — MC
    {
      ...
      hint: 'A passagem secreta não muda o castelo — apenas oferece um atalho que antes não existia',
      opts: [
    ...
    // Q3 — MC
    {
      ...
      hint: 'A TMP e a Escopeta têm funções diferentes mas Leon as usa da mesma forma — IEnumerable é esse contrato comum',
      opts: [
    ...
    // Q4 — MC
    {
      ...
      hint: 'O castelo original tem suas próprias armadilhas — uma passagem nova não as cancela',
      opts: [
    ...
    // Q5 — Fill
    {
      ...
      hint: 'Leon está estendendo o mapa da Vila — o tipo após "this" é o que está sendo explorado',
      ans: 'string',
    ...
    // Q6 — Fill
    {
      ...
      hint: 'A sala das passagens secretas não muda — ela é fixa, como esse modificador obrigatório',
      ans: 'static',
    ...
    // Q7 — Fill
    {
      ...
      hint: 'Leon embaralha os Ganados na área — qual método LINQ ordena por uma chave?',
      ans: 'OrderBy',
    ...
    // Q8 — Fill
    {
      ...
      hint: 'Para acessar a passagem secreta de outro setor do castelo, Leon precisa de um passe — essa diretiva importa o namespace',
      ans: 'using',
    ...
    // Q9 — Code
    {
      ...
      hint: 'HP de Leon está entre os limites de sobrevivência? Verifique os dois intervalos',
      opts: [
    ...
    // Q10 — Code
    {
      ...
      q: 'O que será exibido?',
      hint: 'O HP "100" e "75" são válidos para Leon, mas "abc" não é dano reconhecível',
      opts: [
    ...
    // Q11 — Code
    {
      ...
      q: 'O que será exibido?',
      hint: 'Ashley some no castelo — null é ausência de valor; filtre quem ainda está presente',
      opts: [
        { t: '5', ok: false },
        { t: '2', ok: false },
        { t: '3', ok: true },
    ...
    // Q12 — Code
    {
      ...
      q: 'O que será exibido?',
      hint: 'Leon encadeia cada item no inventário sem largar a bolsa — cada Adicionar() devolve a mesma lista',
      opts: [
        { t: '1', ok: false },
        { t: '3', ok: true },
        { t: '0', ok: false },
