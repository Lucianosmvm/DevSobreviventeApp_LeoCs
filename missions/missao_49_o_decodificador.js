// ══════════════════════════════════════════════════════
// ACT II — O CASTELO
// MISSÃO 49 — O DECODIFICADOR
// Tema: Regex — padrões, Match, IsMatch, Groups, Replace
// Tipo: Normal (12 questões) | Progressão: 4 MC → 4 Fill → 4 Code
// ══════════════════════════════════════════════════════

const missao49 = {
  id: 49, act: 2,
  titulo: "MISSÃO 49 — O DECODIFICADOR",
  subtitulo: "O Castelo",
  descricao: "O decodificador do castelo lê padrões cifrados nas paredes. Expressões Regulares são uma mini-linguagem para buscar, validar e extrair padrões em strings.",
  xp: 210, boss: false,
  steps: [
