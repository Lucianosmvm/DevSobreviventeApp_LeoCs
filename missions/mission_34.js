const MISSION_34 = {
  ...
  steps: [
    ...
    // Q1 — MC (Coleções)
    {
      ...
      hint: 'Saddler não aceita dois Ganados com o mesmo ID — a coleção que garante unicidade automaticamente',
      opts: [
        { t: 'List<int>', ok: false },
    ...
    // Q2 — MC (OOP)
    {
      ...
      hint: 'Leon usa a mesma função de combate para Ganado, Cultista e Regenerador — cada um reage diferente',
      opts: [
    ...
    // Q3 — MC (LINQ)
    {
      ...
      hint: 'Ada prepara a consulta mas só executa quando Leon acessa o resultado — execução adiada como uma emboscada planejada',
      opts: [
    ...
    // Q4 — MC (Generics)
    {
      ...
      hint: 'Para T poder ser null, como Ashley desaparecida, T precisa ser tipo de referência — qual constraint?',
      opts: [
    ...
    // Q5 — MC (Big O)
    {
      ...
      hint: 'Para 10 milhões de buscas, Leon precisa da arma mais rápida — O(1) do HashSet vence O(n) da List',
      opts: [
    ...
    // Q6 — Fill (Dictionary)
    {
      ...
      hint: 'Leon tenta pegar a chave do arsenal sem arriscar KeyNotFoundException — qual método é seguro?',
      ans: 'TryGetValue',
    ...
    // Q7 — Fill (Lambda / Func)
    {
      ...
      hint: 'Ada usa um delegate que recebe dois ints e retorna bool — qual tipo genérico representa funções com retorno?',
      ans: 'Func',
    ...
    // Q8 — Fill (Nullable)
    {
      ...
      hint: 'Se o nome do agente não chegou, use "Anônimo" — duas interrogações formam o operador de fallback',
      ans: '??',
    ...
    // Q9 — Fill (Recursão)
    {
      ...
      hint: 'Quando Leon chega ao fundo sem inimigos, a contagem retorna o valor base — qual é o zero da recursão?',
      ans: '0',
    ...
    // Q10 — Code (List + LINQ)
    {
      ...
      hint: 'Hunnigan filtra os scores de elite, ordena do maior e pega apenas o top 2 de Leon',
      opts: [
        { t: '95, 80', ok: true },
        { t: '80, 55', ok: false },
        { t: '95, 80, 55', ok: false },
    ...
    // Q11 — Code (OOP + Polimorfismo)
    {
      ...
      q: 'O que será exibido?',
      hint: 'El Gigante tem 200 de poder — LINQ Max() encontra o inimigo mais poderoso da sala',
      opts: [
        { t: '50', ok: false },
        { t: '30', ok: false },
        { t: '200', ok: true },
    ...
    // Q12 — Code (Generics)
    {
      ...
      q: 'O que será exibido?',
      hint: 'Leon escolhe a arma com menor recuo — qual o mínimo entre 7 e 3, e entre "z" e "a" na ordem alfabética?',
      opts: [
        { t: '3 e a', ok: true },
        { t: '7 e z', ok: false },
        { t: '3 e z', ok: false },
