...
// ACT II — O CASTELO
// MISSÃO 41 — A CRIPTA
// Tema: Eventos — event, EventHandler, delegate, publisher/subscriber
// Tipo: Normal (12 questões) | Progressão: 4 MC → 4 Fill → 4 Code
// ══════════════════════════════════════════════════════

const missao41 = {
  id: 41, act: 2,
  titulo: "MISSÃO 41 — A CRIPTA",
  subtitulo: "O Castelo",
  descricao: "Na cripta, os cultistas respondem a sinais invisíveis — um sino toca e todos reagem. Eventos são o mecanismo do C# para que objetos se comuniquem sem se conhecerem diretamente.",
  xp: 210, boss: false,
  steps: [
