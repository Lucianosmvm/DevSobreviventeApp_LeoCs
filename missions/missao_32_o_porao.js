...
// ACT II — O CASTELO
// MISSÃO 32 — O PORÃO
// Tema: Nullable<T>, null-safety, ??, ?., is null, patterns
// Tipo: Normal (12 questões) | Progressão: 4 MC → 4 Fill → 4 Code
// ══════════════════════════════════════════════════════

const missao32 = {
  id: 32, act: 2,
  titulo: "MISSÃO 32 — O PORÃO",
  subtitulo: "O Castelo",
  descricao: "No porão do castelo, há armadilhas invisíveis — referências que parecem existir mas não existem. NullReferenceException é o inimigo mais perigoso. Aprenda a lidar com o null.",
  xp: 200, boss: false,
  steps: [
