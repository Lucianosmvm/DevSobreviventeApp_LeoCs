const MISSION_24 = {
  ...
  steps: [
    ...
    // Q1 — MC
    {
      ...
      hint:'Leon, Ashley e Krauser têm dados e comportamentos próprios — OOP modela cada um como objeto do mundo real',
      opts:[
    ...
    // Q2 — MC
    {
      ...
      hint:'O molde "Inimigo" no laboratório de Saddler é a classe — cada Ganado criado é uma instância',
      opts:[
    ...
    // Q3 — MC
    {
      ...
      hint:'Quando Leon entra em cena, o Inimigo é criado com o mesmo nome da classe que o define',
      opts:[
        {t:'Create()', ok:false},
        {t:'Init()', ok:false},
        {t:'Inimigo()', ok:true},
    ...
    // Q4 — MC
    {
      ...
      hint:'O Regenerador herda capacidades do Inimigo básico, mas adiciona poderes extras — filho herda do pai',
      opts:[
    ...
    // Q5 — MC
    {
      ...
      hint:'O HP real de Leon é segredo — nem Saddler pode acessar diretamente de fora',
      opts:[
    ...
    // Q6 — MC
    {
      ...
      hint:'Leon se refere a si mesmo quando diz "meu HP" — é o próprio objeto falando',
      opts:[
    ...
    // Q7 — Fill
    {
      ...
      hint:'O laboratório de Saddler usa um molde (class) para criar criaturas em série',
      ans:'class',
    ...
    // Q8 — Fill
    {
      ...
      hint:'Cada Ganado nasce na Vila com a palavra que cria instâncias no C#',
      ans:'new',
    ...
    // Q9 — Fill
    {
      ...
      hint:'O criador do Inimigo leva o mesmo nome do inimigo — como o molde que dá origem ao produto',
      ans:'Inimigo',
    ...
    // Q10 — Fill
    {
      ...
      hint:'Leon usa o ponto de mira para acessar o Atacar() do inimigo — o operador ponto acessa membros',
      ans:'Atacar',
    ...
    // Q11 — Fill
    {
      ...
      hint:'Leon verifica: "isso é um Regenerador?" — o operador em inglês pergunta se o objeto é de um tipo',
      ans:'is',
    ...
    // Q12 — Code
    {
      ...
      hint:'O Ganado recém-criado usa os valores iniciais definidos no molde — sem parâmetros extras',
      opts:[
    ...
    // Q13 — Code
    {
      ...
      q:'O que será exibido?',
      hint:'O construtor recebe "Regenerador" e 200 HP — esses valores que aparecem na saída',
      opts:[
    ...
    // Q14 — Code
    {
      ...
      q:'O que será exibido?',
      hint:'Ferir s1 não afeta s2 — cada Soldado é um objeto independente na memória, como dois Ganados distintos',
      opts:[
    ...
    // Q15 — Code
    {
      ...
      q:'O que será exibido?',
      hint:'Leon leva dois golpes — rastreie o HP depois de cada dano recebido',
      opts:[
        {t:'False', ok:false},
        {t:'True', ok:true},
        {t:'20', ok:false},
    ...
    // Q16 — Code
    {
      ...
      q:'O que será exibido?',
      hint:'A Matilda de Leon é configurada com Nome e Dano logo quando é criada, sem precisar de construtor',
      opts:[
        {t:'Arma: 0', ok:false},
    ...
    // Q17 — Code
    {
      ...
      q:'O que será exibido?',
      hint:'Krauser se apresenta automaticamente quando Leon o encontra — ToString() é chamado sem precisar pedir',
      opts:[
        {t:'Inimigo', ok:false},
    ...
    // Q18 — Code
    {
      ...
      hint:'Rastreie cada golpe trocado: Leon sofre um ataque, Krauser sofre dois — calcule os HPs finais',
      opts:[
