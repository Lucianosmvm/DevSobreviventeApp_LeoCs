...
const MISSION_62 = {
  ...
  steps: [
    ...
    // Q1 — MC
    {
      ...
      hint: 'O GC limpa a memória, mas Leon precisa fechar a porta do cofre manualmente — conexões e arquivos não se fecham sozinhos',
      opts: [
    ...
    // Q2 — MC
    {
      ...
      hint: 'Mesmo que o Ganado surja do nada e interrompa a missão, Leon sempre fecha a porta ao sair do bunker',
      opts: [
    ...
    // Q3 — MC
    {
      ...
      hint: 'O Regenerador ressurge quando Leon falha em limpá-lo — o finalizer é o último recurso caso Dispose não tenha sido chamado',
      opts: [
    ...
    // Q4 — MC
    {
      ...
      hint: 'O colete de Leon dura o método inteiro, não só o corredor — o escopo determina quando o Dispose é chamado',
      opts: [
    ...
    // Q5 — Fill
    {
      ...
      hint: 'Leon implementa o protocolo de limpeza — a interface é o nome em inglês para "descartável"',
      ans: 'IDisposable',
    ...
    // Q6 — Fill
    {
      ...
      hint: 'A declaração moderna de using — a palavra que acompanha o tipo na linha',
      ans: 'var',
    ...
    // Q7 — Fill
    {
      ...
      hint: 'A classe que você criou na Q5 desta missão — mesma que implementa IDisposable',
      ans: 'ConexaoBase',
    ...
    // Q8 — Code
    {
      ...
      hint: 'Leon entra no bunker (usando) e ao sair fecha a porta — verifique o estado antes e depois',
      opts: [
    ...
    // Q9 — Code
    {
      ...
      q: 'O que será exibido?',
      hint: 'Mesmo que um Ganado surja do nada, Leon fecha o registro antes de reagir à ameaça',
      opts: [
        { t: 'open', ok: false },
    ...
    // Q10 — Code
    {
      ...
      q: 'O que será exibido?',
      hint: 'Tentar liquidar o Ganado que já está no chão — a flag protege contra a segunda ação desnecessária',
      opts: [
