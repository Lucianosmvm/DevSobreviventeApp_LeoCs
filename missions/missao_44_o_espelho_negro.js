// ══════════════════════════════════════════════════════
// ACT II — O CASTELO
// MISSÃO 44 — O ESPELHO NEGRO
// Tema: Pattern Matching — switch expressions, is patterns, when, positional
// Tipo: Normal (12 questões) | Progressão: 4 MC → 4 Fill → 4 Code
// ══════════════════════════════════════════════════════

const missao44 = {
  id: 44, act: 2,
  titulo: "MISSÃO 44 — O ESPELHO NEGRO",
  subtitulo: "O Castelo",
  descricao: "O espelho revela a verdade oculta de cada inimigo. Pattern Matching permite inspecionar, desestruturar e tomar decisões com base na forma exata de um objeto.",
  xp: 210, boss: false,
  steps: [
