const MISSION_49 = {
  ...
  steps: [
    ...
    // Q1 — MC (Coleções)
    {
      ...
      hint: 'O mesmo Ganado não pode ser contado duas vezes — qual coleção garante unicidade automaticamente?',
      opts: [
    ...
    // Q2 — MC (OOP)
    {
      ...
      hint: 'A variável diz "Inimigo" mas o Regenerador executa seu próprio método de regeneração — qual pilar OOP é esse?',
      opts: [
    ...
    // Q3 — MC (LINQ)
    {
      ...
      hint: 'Leon não quer recontar os Ganados toda vez que olha para a lista — ToList() materializa o resultado uma só vez',
      opts: [
    ...
    // Q4 — MC (Async)
    {
      ...
      hint: 'Leon derruba as comunicações e corta a energia ao mesmo tempo — WhenAll executa ambas as missões em paralelo',
      opts: [
    ...
    // Q5 — MC (Events)
    {
      ...
      hint: 'Cultistas externos não podem acionar o alarme diretamente — event protege o mecanismo de notificação',
      opts: [
    ...
    // Q6 — MC (Pattern Matching)
    {
      ...
      hint: 'O inimigo com HP positivo e Nome identificado — property pattern verifica ambas as condições ao mesmo tempo',
      opts: [
    ...
    // Q7 — Fill (Dictionary)
    {
      ...
      hint: 'Leon consulta a pontuação de "Leon" sem lançar exceção — o nome da variável out recebe o valor se existir',
      ans: 'score',
    ...
    // Q8 — Fill (Interface)
    {
      ...
      hint: 'A Shotgun e a TMP têm funções diferentes mas Leon as usa pelo mesmo contrato — a palavra-chave que define esse contrato',
      ans: 'interface',
    ...
    // Q9 — Fill (Generics)
    {
      ...
      hint: 'O arsenal de Leon funciona para qualquer tipo de arma — o placeholder de tipo genérico por convenção',
      ans: 'T',
    ...
    // Q10 — Fill (Async/IO)
    {
      ...
      hint: 'Leon lê o arquivo dos Illuminados sem travar a operação — versão assíncrona do método que lê tudo como string',
    ...
    // Q11 — Fill (DateTime)
    {
      ...
      hint: 'Ada usa o formato universal das APIs — ano, mês, dia, separador T, hora e minuto',
    ...
    // Q12 — Fill (JSON)
    {
      ...
      hint: 'O grimório formatado para o capitão Salazar tem espaços e quebras de linha — qual opção ativa isso?',
      ans: 'WriteIndented',
    ...
    // Q13 — Code (LINQ + OOP)
    {
      ...
      hint: 'Saddler e Krauser são os chefes — some apenas o HP deles e ignore os Ganados comuns',
      opts: [
        { t: '1610', ok: false },
        { t: '1500', ok: true },
        { t: '500', ok: false },
    ...
    // Q14 — Code (Events + Async)
    {
      ...
      hint: 'O Motor dobra o número de Ganados detectados — 21 inimigos viram quantos após a multiplicação?',
      opts: [
    ...
    // Q15 — Code (Pattern + Dictionary)
    {
      ...
      q: 'O que será exibido?',
      hint: 'O arsenalcategoriza as armas de Leon por dano — Pistola fraca, Escopeta média, Rifle pesado',
      opts: [
    ...
    // Q16 — Code (Regex + JSON)
    {
      ...
      q: 'O que será exibido?',
      hint: 'O grimório válido dos Illuminados começa e termina com chaves — o padrão Regex verifica isso',
      opts: [
    ...
    // Q17 — Code (DateTime + LINQ)
    {
      ...
      hint: 'A missão do Castelo em março e a da Vila em 5 de fevereiro são posteriores ao corte de 1º de fevereiro',
      opts: [
        { t: '1', ok: false },
        { t: '2', ok: true },
        { t: '3', ok: false },
    ...
    // Q18 — Code (IO + JSON)
    {
      ...
      q: 'O que será exibido?',
      hint: 'O save de Leon na Missão 49 é serializado e recuperado — todos os dados devem voltar intactos',
      opts: [
    ...
    // Q19 — Code (Extension + Pattern + LINQ)
    {
      ...
      q: 'O que será exibido?',
      hint: 'Leon com HP 100 está seguro; com 25 em perigo; morto em 0; ferido com 55 — o extension switch expression decide',
      opts: [
        { t: '🟢 🔴 💀 🟡', ok: true },
        { t: '🟢 🟡 💀 🟡', ok: false },
        { t: '🟢 🔴 🔴 🟡', ok: false },
    ...
    // Q20 — Code (DESAFIO FINAL ACT II)
    {
      ...
      q: 'O que será exibido?',
      hint: 'Infiltração e Castelo completos somam 300 XP — Rank A ou B depende de atingir ou não a meta',
      opts: [
