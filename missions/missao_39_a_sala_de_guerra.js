// ══════════════════════════════════════════════════════
// ACT II — O CASTELO
// MISSÃO 39 — A SALA DE GUERRA
// Tema: Enums (flags, conversão) e Structs (value type)
// Tipo: Normal (12 questões) | Progressão: 4 MC → 4 Fill → 4 Code
// ══════════════════════════════════════════════════════

const missao39 = {
  id: 39, act: 2,
  titulo: "MISSÃO 39 — A SALA DE GUERRA",
  subtitulo: "O Castelo",
  descricao: "Na sala de guerra, cada status de missão tem um nome preciso — não números soltos. Enums dão nomes a constantes inteiras. Structs são tipos de valor leves para dados pequenos.",
  xp: 210, boss: false,
  steps: [
