...
const MISSION_10 = {
  ...
  steps: [
    ...
    // Q1 — MC
    {
      ...
      hint:'A ronda de Leon: começa no portão (init), patrulha enquanto não terminou (condição), avança para o próximo ponto (incremento)',
      opts:[
    ...
    // Q2 — MC
    {
      ...
      hint:'A ronda noturna tem 100 pontos fixos — quando o número de iterações é conhecido, o for é o loop certo',
      opts:[
    ...
    // Q3 — MC
    {
      ...
      hint:'Leon cobre posições alternadas da ronda — avança dois pontos por vez',
      opts:[
    ...
    // Q4 — MC
    {
      ...
      hint:'3 fileiras do Castelo com 4 Ganados cada — o loop interno percorre todos antes de avançar a fileira',
      opts:[
    ...
    // Q5 — Fill
    {
      ...
      hint:'O arsenal de Leon tem um comprimento fixo — qual propriedade retorna o tamanho do array?',
      ans:'Length',
    ...
    // Q6 — Fill
    {
      ...
      hint:'Leon percorre a lista de trás para frente — o operador que diminui 1 a cada passo',
      ans:'--',
    ...
    // Q7 — Fill
    {
      ...
      hint:'O segundo Ganado na grade precisa de um contador diferente — convenção: i, depois a próxima letra',
      ans:'j',
    ...
    // Q8 — Fill
    {
      ...
      hint:'Leon usa o índice i para pegar cada bala do arsenal — qual variável acessa a posição atual?',
      ans:'i',
    ...
    // Q9 — Code
    {
      ...
      hint:'O dano de Leon cresce ao quadrado a cada nível — calcule i*i para cada valor de 1 a 5',
      opts:[
    ...
    // Q10 — Code
    {
      ...
      hint:'O mapa do Castelo tem 3 linhas de salas — o loop externo determina quantas linhas são exibidas',
      opts:[
    ...
    // Q11 — Code
    {
      ...
      q:'O que será exibido?',
      hint:'Leon verifica posições pares da ronda: 0, 2, 4 até 10 — i += 2 pula de dois em dois',
      opts:[
    ...
    // Q12 — Code
    {
      ...
      hint:'El Gigante causa mais dano que todos os outros — qual é o maior valor no array de danos?',
      opts:[
