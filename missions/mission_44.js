const MISSION_44 = {
  ...
  steps: [
    ...
    // Q1 — MC (Exceções)
    {
      ...
      hint: 'Mesmo que o castelo exploda, o relatório de Leon é entregue — só Environment.FailFast impede o finally',
      opts: [
    ...
    // Q2 — MC (StringBuilder)
    {
      ...
      hint: 'Leon monta o relatório peça por peça sem descartar cada folha — o padrão Builder evita cópias intermediárias',
      opts: [
    ...
    // Q3 — MC (Enums)
    {
      ...
      hint: 'As Bella Sisters combinam força e velocidade ao mesmo tempo — esse atributo permite combinar valores de enum',
      opts: [
    ...
    // Q4 — MC (Async)
    {
      ...
      hint: 'Uma granada no bolso de Leon que ele não consegue desativar — async void lança exceção que ninguém pode capturar',
      opts: [
    ...
    // Q5 — MC (Events)
    {
      ...
      hint: 'Saddler mantém os cultistas ligados a ele mesmo quando deveriam ser dispensados — o publisher segura o subscriber na memória',
      opts: [
    ...
    // Q6 — MC (Pattern Matching)
    {
      ...
      hint: 'Saddler tem um plano para cada situação — sem o padrão _ cobrindo tudo, alguém escapa sem ser tratado',
      opts: [
    ...
    // Q7 — Fill (Exceções customizadas)
    {
      ...
      hint: 'Toda falha de missão em RE4 herda de um problema maior — exceções customizadas herdam desta classe raiz',
      ans: 'Exception',
    ...
    // Q8 — Fill (Records)
    {
      ...
      hint: 'O arquivo dos Illuminados — imutável, com igualdade por valor, como um registro histórico selado',
      ans: 'record',
    ...
    // Q9 — Fill (Extension Methods)
    {
      ...
      hint: 'Leon entra em zona de perigo quando o HP cai abaixo de um número específico — qual é esse limite?',
      ans: '20',
    ...
    // Q10 — Fill (Async)
    {
      ...
      hint: 'A missão retorna um bool — verdadeiro ou falso. Task embrulha qualquer tipo de retorno async',
      ans: 'Task',
    ...
    // Q11 — Fill (Tuplas)
    {
      ...
      hint: 'Leon desestrutura a ficha do personagem — o primeiro valor da tupla é o nome do agente',
      ans: 'nome',
    ...
    // Q12 — Code (Exceções)
    {
      ...
      hint: 'Leon encontra divisão por zero — o catch responde, o finally fecha a porta, e o resultado chega por último',
      opts: [
    ...
    // Q13 — Code (StringBuilder)
    {
      ...
      q: 'O que será exibido?',
      hint: 'Leon registra apenas a inicial de cada inimigo eliminado — o StringBuilder acumula letra por letra',
      opts: [
        { t: 'GCG', ok: true },
    ...
    // Q14 — Code (Enum Flags)
    {
      ...
      q: 'O que será exibido?',
      hint: 'Leon tem acesso de Ler e Executar — mas será que também tem permissão de Escrever?',
      opts: [
    ...
    // Q15 — Code (Event + Pattern)
    {
      ...
      q: 'O que será exibido?',
      hint: 'O Ganado está a 8 metros — nem perigoso demais nem seguro — qual faixa do switch expression captura?',
      opts: [
        { t: '🔴 Perigoso', ok: false },
        { t: '🟡 Alerta', ok: true },
        { t: '🟢 Seguro', ok: false },
    ...
    // Q16 — Code (Extension + LINQ)
    {
      ...
      q: 'O que será exibido?',
      hint: 'Leon só coleta granadas de número par no inventário — quais são e qual a soma?',
      opts: [
        { t: '21', ok: false },
        { t: '12', ok: true },
        { t: '6', ok: false },
    ...
    // Q17 — Code (Record + Tupla)
    {
      ...
      q: 'O que será exibido?',
      hint: 'O relatório da Infiltração é copiado com novo XP — with{} cria cópia imutável sem alterar o original',
      opts: [
    ...
    // Q18 — Code (DESAFIO FINAL)
    {
      ...
      hint: 'Leon com HP 25 — ainda vivo mas na zona crítica do switch expression',
      opts: [
