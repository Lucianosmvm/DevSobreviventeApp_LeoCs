// ══════════════════════════════════════════════════════
// ACT II — O CASTELO
// MISSÃO 46 — O ARQUIVO SECRETO
// Tema: File, Directory, StreamReader, StreamWriter, Path
// Tipo: Normal (12 questões) | Progressão: 4 MC → 4 Fill → 4 Code
// ══════════════════════════════════════════════════════

const missao46 = {
  id: 46, act: 2,
  titulo: "MISSÃO 46 — O ARQUIVO SECRETO",
  subtitulo: "O Castelo",
  descricao: "Nos arquivos do castelo residem os segredos do Los Illuminados. File IO permite ler e gravar dados persistentes — informações que sobrevivem além da execução do programa.",
  xp: 210, boss: false,
  steps: [
