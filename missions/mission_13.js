...
const MISSION_13 = {
  ...
  steps: [
    ...
    // Q1 — MC
    {
      ...
      hint:'O depósito tem 3 prateleiras com 4 colunas cada — quantos itens no total?',
      opts:[
    ...
    // Q2 — MC
    {
      ...
      hint:'O mapa do Castelo tem salas regulares; a Vila tem corredores de tamanho variável — qual é qual?',
      opts:[
    ...
    // Q3 — MC
    {
      ...
      hint:'GetLength(0) conta as linhas, GetLength(1) conta as colunas — qual dimensão tem as colunas?',
      opts:[
    ...
    // Q4 — MC
    {
      ...
      hint:'O mapa da Vila de RE4 é uma grade de células — linhas e colunas se encaixam perfeitamente num array 2D',
      opts:[
    ...
    // Q5 — Fill
    {
      ...
      hint:'Leon acessa a terceira coluna do estoque — coluna 2 porque os índices começam em zero',
      ans:'2',
    ...
    // Q6 — Fill
    {
      ...
      hint:'O canto inferior esquerdo do mapa não tem Ganado — qual valor representa ausência de inimigo?',
      ans:'0',
    ...
    // Q7 — Fill
    {
      ...
      hint:'Para percorrer as colunas do mapa, GetLength precisa da segunda dimensão — qual índice?',
      ans:'1',
    ...
    // Q8 — Code
    {
      ...
      hint:'Leon acessa a segunda linha (índice 1) e a terceira coluna (índice 2) do mapa do Castelo',
      opts:[
    ...
    // Q9 — Code
    {
      ...
      hint:'Leon soma todos os suprimentos do estoque 2D — percorra cada célula e acumule o total',
      opts:[
    ...
    // Q10 — Code
    {
      ...
      q:'O que será exibido?',
      hint:'O array jagged tem linhas de tamanhos diferentes — jagged[1][2] é a linha 1, elemento de índice 2',
      opts:[
