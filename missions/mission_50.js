...
const MISSION_50 = {
  ...
  steps: [
    ...
    // Q1 — MC
    {
      ...
      hint: 'Leon não fica parado esperando o elevador da Ilha chegar — ele continua em movimento enquanto aguarda',
      opts: [
    ...
    // Q2 — MC
    {
      ...
      hint: 'Ada não paralisa quando envia o sinal — await suspende o método, não o agente que continua agindo',
      opts: [
    ...
    // Q3 — MC
    {
      ...
      hint: 'A missão promete retornar um número de inimigos — Task embrulha o tipo que virá depois',
      opts: [
        { t: 'int', ok: false },
    ...
    // Q4 — MC
    {
      ...
      hint: 'Um Ganado parado no corredor bloqueia a passagem; Task.Delay libera Leon para agir enquanto espera',
      opts: [
    ...
    // Q5 — Fill
    {
      ...
      hint: 'Leon infiltra a base de forma não bloqueante — a palavra-chave que marca o método como assíncrono',
      ans: 'async',
    ...
    // Q6 — Fill
    {
      ...
      hint: 'Leon aguarda a resposta de Ada antes de abrir a porta — essa palavra extrai o resultado da Task',
      ans: 'await',
    ...
    // Q7 — Fill
    {
      ...
      hint: 'A patrulha não retorna nada, só executa — async sem valor de retorno usa essa palavra como tipo',
      ans: 'Task',
    ...
    // Q8 — Code
    {
      ...
      hint: 'Leon contou 42 inimigos na base — await desempacota o valor da Task<int>',
      opts: [
        { t: '0', ok: false },
        { t: '42', ok: true },
        { t: 'Task<int>', ok: false },
    ...
    // Q9 — Code
    {
      ...
      hint: 'Leon prepara, infiltra e conclui em sequência — cada await mantém a ordem lógica da operação',
      opts: [
    ...
    // Q10 — Code
    {
      ...
      q: 'O que será exibido?',
      hint: 'Leon soma os inimigos de cada corredor de 1 a 5 em background — qual o total?',
      opts: [
        { t: '10', ok: false },
        { t: '15', ok: true },
        { t: '5', ok: false },
