// ══════════════════════════════════════════════════════
// ACT II — O CASTELO
// MISSÃO 29 — A TORRE DO RELÓGIO
// Tema: LINQ — Where, Select, OrderBy, First, Count, Sum, Any, All
// Tipo: Normal (12 questões) | Progressão: 4 MC → 4 Fill → 4 Code
// ══════════════════════════════════════════════════════

const missao29 = {
  id: 29, act: 2,
  titulo: "MISSÃO 29 — A TORRE DO RELÓGIO",
  subtitulo: "O Castelo",
  descricao: "O relógio filtra, ordena e transforma. LINQ (Language Integrated Query) é a linguagem de consulta embutida no C# — manipule coleções com elegância e poder.",
  xp: 200, boss: false,
  steps: [
