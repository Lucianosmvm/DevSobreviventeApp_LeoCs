// ══════════════════════════════════════════════════════
// ACT II — O CASTELO
// MISSÃO 21 — PORTÃO DO CASTELO
// Tema: Introdução a coleções (List, Dictionary, Stack, Queue)
// Tipo: Normal (11 questões) | Progressão: 5 MC → 3 Fill → 3 Code
// ══════════════════════════════════════════════════════

const missao21 = {
  id: 21, act: 2,
  titulo: "MISSÃO 21 — PORTÃO DO CASTELO",
  subtitulo: "O Castelo",
  descricao: "Você cruzou o portão do castelo. Aqui a missão se torna mais complexa — arrays simples não bastam mais. As coleções do C# são suas novas ferramentas de sobrevivência.",
  xp: 160, boss: false,
  steps: [
