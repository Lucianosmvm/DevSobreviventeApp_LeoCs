const MISSION_23 = {
  ...
  steps: [
    ...
    // Q1 — MC
    {
      ...
      hint:'A lista de inimigos únicos da Vila não repete o mesmo Ganado — cada um aparece só uma vez',
      opts:[
    ...
    // Q2 — MC
    {
      ...
      hint:'Leon espia pela porta antes de entrar — ver sem remover o inimigo do caminho',
      opts:[
        {t:'Dequeue()', ok:false},
        {t:'Front()', ok:false},
        {t:'Peek()', ok:true},
    ...
    // Q3 — MC
    {
      ...
      hint:'Leon e Ada se encontram onde seus caminhos se cruzam — apenas os inimigos que ambos enfrentam',
      opts:[
    ...
    // Q4 — MC
    {
      ...
      hint:'As missões de Hunnigan chegam em ordem e devem ser processadas na mesma ordem — o primeiro pedido é o primeiro atendido',
      opts:[
    ...
    // Q5 — Fill
    {
      ...
      hint:'Leon empilha cada tarefa no topo da pilha de ações — como empurrar um bloco para cima',
      ans:'Push',
    ...
    // Q6 — Fill
    {
      ...
      hint:'O Ganado que chegou primeiro na fila do corredor sai primeiro para enfrentar Leon',
      ans:'Dequeue',
    ...
    // Q7 — Fill
    {
      ...
      hint:'Leon marca a Sala 1 como visitada — o mesmo gesto de marcar no mapa do Castelo',
      ans:'Add',
    ...
    // Q8 — Code
    {
      ...
      hint:'As missões de Leon são processadas na mesma ordem em que Hunnigan as enviou',
      opts:[
        {t:'C B A', ok:false},
        {t:'A B C', ok:true},
        {t:'B A C', ok:false},
    ...
    // Q9 — Code
    {
      ...
      hint:'O relatório de Leon lista cada tipo de inimigo uma vez — mesmo que apareça várias vezes na missão',
      opts:[
    ...
    // Q10 — Code
    {
      ...
      hint:'Para desfazer ações no Castelo, Leon reverte a última coisa que fez — não a primeira',
      opts:[
    ...
    // Q11 — Code
    {
      ...
      hint:'Saddler não está na lista de acesso autorizado por Hunnigan — será bloqueado',
      opts:[
