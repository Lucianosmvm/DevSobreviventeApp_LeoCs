...
const MISSION_63 = {
  ...
  steps: [
    ...
    // Q1 — MC
    {
      ...
      hint: 'Dois Ganados atacando Leon ao mesmo tempo podem se atrapalhar — o resultado final não é a soma das investidas',
      opts: [
    ...
    // Q2 — MC
    {
      ...
      hint: 'Leon usa um cadeado próprio para a porta do bunker — não empresta a chave para outros usarem ao mesmo tempo',
      opts: [
    ...
    // Q3 — MC
    {
      ...
      hint: 'Para contar Ganados eliminados, Interlocked é mais rápido do que travar toda a sala com lock',
      opts: [
    ...
    // Q4 — MC
    {
      ...
      hint: 'Leon e Krauser esperando um pelo outro para passar — a ordem de quem entra primeiro precisa ser sempre a mesma',
      opts: [
    ...
    // Q5 — MC
    {
      ...
      hint: 'O helicóptero de extração tem vagas limitadas — a primitiva controla quantos podem entrar ao mesmo tempo',
      opts: [
    ...
    // Q6 — MC
    {
      ...
      hint: 'Ada muda o sinal de parada e Leon precisa ver esse valor atualizado imediatamente, sem cache de CPU',
      opts: [
    ...
    // Q7 — Fill
    {
      ...
      hint: 'A única saída da cela do Castelo — a palavra que bloqueia o acesso ao objeto compartilhado',
      ans: 'lock',
    ...
    // Q8 — Fill
    {
      ...
      hint: 'Leon adiciona mais um ao contador de Ganados — o método Interlocked que faz exatamente isso',
      ans: 'Increment',
    ...
    // Q9 — Fill
    {
      ...
      hint: 'Leon sai do helicóptero e libera a vaga para o próximo — o método que sinaliza que uma vaga ficou disponível',
      ans: 'Release',
    ...
    // Q10 — Fill
    {
      ...
      hint: 'Ada só troca o arquivo se o original ainda for o esperado — compare e substitua atomicamente se a condição for verdadeira',
      ans: 'CompareExchange',
    ...
    // Q11 — Fill
    {
      ...
      hint: 'O sinal de Ada precisa ser visto por Leon imediatamente — sem cache, sem atraso entre threads',
      ans: 'volatile',
    ...
    // Q12 — Code
    {
      ...
      hint: '10 Ganados eliminados por 10 agentes com lock — nenhum incremento é perdido',
      opts: [
    ...
    // Q13 — Code
    {
      ...
      q: 'O que será exibido?',
      hint: 'Cada agente soma seu dano ao total — some os valores de 1 a 5',
      opts: [
    ...
    // Q14 — Code
    {
      ...
      hint: 'Leon tenta abrir a porta agora — se ninguém estiver usando, ele passa; o timeout 0 não espera',
      opts: [
    ...
    // Q15 — Code
    {
      ...
      q: 'O que será exibido?',
      hint: 'Ada e Leon podem ler o mesmo arquivo ao mesmo tempo, mas apenas um escreve — dois leitores após Escrever(42)',
      opts: [
        { t: '0 0', ok: false },
        { t: '42 42', ok: true },
        { t: '42 0', ok: false },
    ...
    // Q16 — Code
    {
      ...
      q: 'O que será exibido?',
      hint: 'O corredor do Castelo tem espaço para um agente — SemaphoreSlim(1,1) garante exclusão como um mutex',
      opts: [
    ...
    // Q17 — Code
    {
      ...
      q: 'O que será exibido?',
      hint: 'Ashley só é resgatada na primeira vez que Leon chega — Lazy cria o objeto uma única vez, ao acessar .Value',
      opts: [
    ...
    // Q18 — Code (DESAFIO CHEFE)
    {
      ...
      q: 'O que será exibido?',
      hint: 'Cada Ganado causa um dano diferente — some todos e encontre quem causou mais estrago',
      opts: [
