...
const MISSION_67 = {
  ...
  steps: [
    ...
    // Q1 — MC
    {
      ...
      hint: 'Leon precisa listar os agentes em ordem alfabética para o relatório — prefira SortedDictionary quando a iteração ordenada importa',
      opts: [
    ...
    // Q2 — MC
    {
      ...
      hint: 'Ada se infiltra entre dois Ganados na fila sem mover os demais — inserção no meio sem deslocar elementos',
      opts: [
    ...
    // Q3 — MC
    {
      ...
      hint: 'Resgatar Ashley é prioridade 1 — menor número significa missão mais urgente na fila',
      opts: [
    ...
    // Q4 — MC
    {
      ...
      hint: 'O inventário de Leon não repete armas e as lista em ordem — você precisa de elementos únicos e ordenados',
      opts: [
    ...
    // Q5 — MC
    {
      ...
      hint: 'Leon desfaz o último disparo primeiro — o que entrou por último sai primeiro',
      opts: [
        { t: 'Queue<T>', ok: false },
    ...
    // Q6 — MC
    {
      ...
      hint: 'O rádio de Leon guarda apenas os últimos N alertas — ao encher, o mais antigo é descartado',
      opts: [
    ...
    // Q7 — Fill
    {
      ...
      hint: 'Leon registra o score de cada agente — o método que insere um par chave-valor no dicionário',
      ans: 'Add',
    ...
    // Q8 — Fill
    {
      ...
      hint: 'Ada se posiciona logo depois de Leon na fila — o método insere um nó após um nó referenciado',
      ans: 'AddAfter',
    ...
    // Q9 — Fill
    {
      ...
      hint: 'Leon coloca a missão urgente na fila com sua prioridade — o método que adiciona elemento e prioridade',
      ans: 'Enqueue',
    ...
    // Q10 — Fill
    {
      ...
      hint: 'Leon remove a última ação do histórico — o método que retira e retorna o topo da pilha',
      ans: 'Pop',
    ...
    // Q11 — Fill
    {
      ...
      hint: 'Leon pega apenas os 3 melhores agentes — o método LINQ que limita a N elementos',
      ans: 'Take',
    ...
    // Q12 — Code
    {
      ...
      hint: 'O SortedDictionary organiza os agentes como fichas em ordem — Ada vem antes de Leon',
      opts: [
    ...
    // Q13 — Code
    {
      ...
      hint: 'Ada entra entre Leon e o próximo agente — AddAfter insere o 2 logo depois do nó 1',
      opts: [
        { t: '1,3,2', ok: false },
        { t: '1,2,3', ok: true },
        { t: '2,1,3', ok: false },
    ...
    // Q14 — Code
    {
      ...
      q: 'O que será exibido?',
      hint: 'Resgatar Ashley tem prioridade 1 — a PriorityQueue processa do menor número para o maior',
      opts: [
    ...
    // Q15 — Code
    {
      ...
      q: 'O que será exibido?',
      hint: 'O rádio de Leon só guarda os 3 últimos alertas — ao encher, o mais antigo é descartado',
      opts: [
        { t: '1,2,3', ok: false },
        { t: '3,4,5', ok: true },
    ...
    // Q16 — Code
    {
      ...
      q: 'O que será exibido?',
      hint: 'Os Ganados que aparecem em ambas as patrulhas de Saddler — apenas os elementos em comum',
      opts: [
    ...
    // Q17 — Code
    {
      ...
      q: 'O que será exibido?',
      hint: 'Cada porta do Castelo que Leon abre precisa ser fechada — a Stack verifica se todos os parênteses foram balanceados',
      opts: [
        { t: 'False', ok: false },
        { t: 'True', ok: true },
    ...
    // Q18 — Code (DESAFIO CHEFE)
    {
      ...
      q: 'O que será exibido?',
      hint: 'Leon coleta o XP de cada missão ao processá-la — some o XP de todas as tarefas independente da ordem',
      opts: [
        { t: '500', ok: false },
        { t: '1000', ok: true },
        { t: '300', ok: false },
