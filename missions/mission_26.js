const MISSION_26 = {
  ...
  steps: [
    ...
    // Q1 — MC
    {
      ...
      hint: 'O Regenerador é um Inimigo especial — os dois pontos unem filho ao pai em C#',
      opts: [
    ...
    // Q2 — MC
    {
      ...
      hint: 'Saddler não permite que o Regenerador improvise — sem autorização virtual, o override é bloqueado',
      opts: [
    ...
    // Q3 — MC
    {
      ...
      hint: 'A referência diz Inimigo, mas o Regenerador que ataca é o objeto real — polimorfismo decide em runtime',
      opts: [
    ...
    // Q4 — MC
    {
      ...
      hint: 'O Regenerador chama o construtor do Inimigo pai antes de adicionar sua própria regeneração',
      opts: [
    ...
    // Q5 — Fill
    {
      ...
      hint: 'O ataque padrão do Inimigo pode ser substituído por versões especiais — como o Cultista tem seu próprio ataque',
      ans: 'virtual',
    ...
    // Q6 — Fill
    {
      ...
      hint: 'O Regenerador sobrescreve o ataque padrão do Inimigo com sua versão mais letal',
      ans: 'override',
    ...
    // Q7 — Fill
    {
      ...
      hint: 'O Cultista usa o ataque básico do Inimigo pai e adiciona veneno por cima',
      ans: 'base',
    ...
    // Q8 — Fill
    {
      ...
      hint: 'Saddler é o fim da linha — nenhuma criatura pode herdar dele, como uma porta lacrada no Castelo',
      ans: 'sealed',
    ...
    // Q9 — Code
    {
      ...
      hint: 'O construtor pai recebe o nome e HP — rastreie os valores passados via base()',
      opts: [
    ...
    // Q10 — Code
    {
      ...
      q: 'O que será exibido?',
      hint: 'A referência é Inimigo, mas quem grita é o Cultista fiel de Salazar — o objeto real decide',
      opts: [
        { t: 'Argh!', ok: false },
    ...
    // Q11 — Code
    {
      ...
      q: 'O que será exibido?',
      hint: 'O Chefe executa a morte padrão do Inimigo e depois adiciona sua cena épica — base() vem antes',
      opts: [
    ...
    // Q12 — Code
    {
      ...
      q: 'O que será exibido?',
      hint: 'A sala tem Ganados e Cultistas — cada um revela seu tipo quando Leon os identifica',
      opts: [
