const MISSION_22 = {
  ...
  steps: [
    ...
    // Q1 — MC
    {
      ...
      hint:'Leon usa colete antes de entrar na sala — TryGetValue é o colete contra KeyNotFoundException',
      opts:[
    ...
    // Q2 — MC
    {
      ...
      hint:'Ada desestrutura o briefing: nome da missão e coordenadas separados de uma vez',
      opts:[
    ...
    // Q3 — MC
    {
      ...
      hint:'Se a Lança não está no arsenal, Leon usa o dano padrão de emergência',
      opts:[
    ...
    // Q4 — MC
    {
      ...
      hint:'Hunnigan mapeia cada tipo de inimigo para quantas vezes Leon os eliminou',
      opts:[
    ...
    // Q5 — Fill
    {
      ...
      hint:'Leon descarta a Faca do arsenal após ela quebrar no confronto com Krauser',
      ans:'Remove',
    ...
    // Q6 — Fill
    {
      ...
      hint:'Leon só quer o dano de cada arma, não o nome — apenas os valores do arsenal',
      ans:'Values',
    ...
    // Q7 — Fill
    {
      ...
      hint:'TryGetValue extrai as balas da Pistola com segurança — se existir, a variável recebe o valor',
      ans:'balas',
    ...
    // Q8 — Fill
    {
      ...
      hint:'Rank S é o mais alto — o número 1 representa o melhor, como Leon ser o agente topo da divisão',
      ans:'1',
    ...
    // Q9 — Code
    {
      ...
      hint:'Ada trabalha nas sombras — ela pode não estar no mapa visível de Leon',
      opts:[
        {t:'Ada: 0', ok:false},
    ...
    // Q10 — Code
    {
      ...
      hint:'Hunnigan conta cada Ganado eliminado por Leon — rastreie as repetições no array',
      opts:[
    ...
    // Q11 — Code
    {
      ...
      q:'O que será exibido?',
      hint:'Ada recebeu o número 2 na missão — no dicionário invertido, quem tem esse número?',
      opts:[
    ...
    // Q12 — Code
    {
      ...
      q:'O que será exibido?',
      hint:'O rádio de Leon recebeu o comando "recarregar" — qual ação do arsenal é ativada?',
      opts:[
